...
var __defProp = Object.defineProperty, __getOwnPropDesc = Object.getOwnPropertyDescriptor, __getOwnPropNames = Object.getOwnPropertyNames, __hasOwnProp = Object.prototype.hasOwnProperty, __esmMin = (e, t) => () => (e && (t = e(e = 0)), t), __commonJSMin = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), __export = (e, t) => {
	let n = {};
	...
	if (t && typeof t == "object" || typeof t == "function") for (var i = __getOwnPropNames(t), a = 0, o = i.length, d; a < o; a++) d = i[a], !__hasOwnProp.call(e, d) && d !== n && __defProp(e, d, {
		get: ((e) => t[e]).bind(null, d),
		enumerable: !(r = __getOwnPropDesc(t, d)) || r.enumerable
	});
	return e;
}, __toCommonJS = (e) => __hasOwnProp.call(e, "module.exports") ? e["module.exports"] : __copyProps(__defProp({}, "__esModule", { value: !0 }), e), __require = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
	if (typeof require < "u") return require.apply(this, arguments);
	throw Error("Calling `require` for \"" + e + "\" in an environment that doesn't expose the `require` function.");
});
async function loadCredentialFromFile(e) {
	try {
		return await readFile(e, { encoding: "utf8" });
	} catch (e) {
		throw e.name === "TypeError" || e.name === "Error" ? Error(`Load credential error: ${e.message}`) : e;
	}
}
function parseBigQueryCredential(e) {
	try {
		let { project_id: t, client_email: n, private_key: r, datasets: i } = JSON.parse(e), a = { datasets: Array.isArray(i) ? i.filter((e) => typeof e == "string") : [] };
		if (t !== void 0) {
			if (typeof t != "string" || !t || !t.trim()) throw Error("project_id must be a non-empty string when provided");
			a.projectId = t;
		}
		if (n !== void 0 || r !== void 0) {
			if (!n || typeof n != "string" || !n.trim()) throw Error("client_email must be a non-empty string when credentials are provided");
			if (!r || typeof r != "string" || !r.trim()) throw Error("private_key must be a non-empty string when credentials are provided");
			a.credentials = {
				clientEmail: n,
				privateKey: r
			};
		...
		throw e instanceof SyntaxError ? Error("Credentials must be in JSON format") : e;
	}
}
function getIntersection(e, t) {
	return e.filter((e) => t.includes(e));
}
function getTableSchemaKey(e, t) {
	if (!t || !t.trim()) throw Error("Table name must be a non-empty string");
	return e ? `${e}.${t}` : `${t}`;
}
function mergeTables(e, t) {
	return e.concat(t);
}
function mergeFieldDictionary(e, t) {
	let n = { ...e };
	return Object.keys(t).forEach((e) => {
		n[e] || (n[e] = []), n[e] = n[e].concat(t[e]);
	}), n;
}
function mergeIndexDictionary(e, t) {
	let n = { ...e };
	return Object.keys(t).forEach((e) => {
		n[e] || (n[e] = []), n[e] = n[e].concat(t[e]);
	}), n;
}
function mergeTableConstraintDictionary(e, t) {
	let n = { ...e };
	return Object.keys(t).forEach((e) => {
		n[e] || (n[e] = {}), n[e] = t[e];
	}), n;
}
async function connectBigQuery(t) {
	let n = {};
	t?.projectId && (n.projectId = t.projectId), t?.credentials?.clientEmail && t?.credentials?.privateKey && (n.credentials = {
		client_email: t.credentials.clientEmail,
		private_key: t.credentials.privateKey
	});
	let r = new BigQuery(n);
	try {
		return await r.query("SELECT CURRENT_DATE() as today"), r;
	} catch (e) {
		throw e instanceof Error ? Error(`BigQuery connection error: ${e.message}`) : e;
	}
}
function getDbDefault$1(e, t) {
	return t === null ? null : t === "string" ? {
		value: e.slice(1, -1).replaceAll("'", "'"),
		type: t
	} : {
		value: e,
		type: t
...
function generateField$5(e) {
	let { columnName: t, isNullable: n, dataType: r, columnDefault: i, columnDefaultType: a, columnDescription: o } = e, s = getDbDefault$1(i, a);
	return {
		name: t,
		not_null: n === "NO",
		type: {
...
async function generateTablesAndFields$4(e, t, n) {
	let r = `${t}.${n}`, i = `
    with
      table_comments as (
  ...
  `, [a] = await e.query({ query: i }), o = {}, s = {};
	return a.forEach((e) => {
		let { tableSchema: t, tableName: n, tableComment: r } = e, i = getTableSchemaKey(t, n);
		o[i] || (o[i] = {
			name: n,
			note: { value: r || "" },
			schemaName: t
		}), s[i] || (s[i] = []);
		let a = generateField$5(e);
		s[i].push(a);
	}), {
		tables: Object.values(o),
		fieldMap: s
	};
}
async function generateIndexes$3(e, t, n) {
	let r = `${t}.${n}`, i = `
    select
  ...
  `, [a] = await e.query(i), o = {};
	return a.forEach((e) => {
		let { indexSchema: t, tableName: n, indexName: r, indexColumnNames: i } = e, a = {
			name: r,
			type: "",
			columns: [...i.split(", ").map((e) => ({
				type: "column",
				value: e
			}))]
		}, s = getTableSchemaKey(t, n);
		o[s] ? o[s].push(a) : o[s] = [a];
	}), o;
}
async function generateTableConstraints(e, t, n) {
	let r = `${t}.${n}`, i = `
    select
  ...
  `, [a] = await e.query(i), o = a.filter((e) => e.columnCount && e.columnCount === 1), s = a.filter((e) => e.columnCount && e.columnCount > 1), c = {};
	o.forEach((e) => {
		let { tableSchema: t, tableName: n, columnNames: r } = e, i = getTableSchemaKey(t, n);
		c[i] || (c[i] = {}), c[i][r] || (c[i][r] = { checks: [] }), c[i][r].pk = !0;
	});
	let l = {};
	return s.forEach((e) => {
		let { tableSchema: t, tableName: n, constraintName: r, columnNames: i } = e, a = {
			name: r,
			type: "",
			columns: [...i.split(", ").map((e) => ({
				type: "column",
			...
			pk: !0
		}, o = getTableSchemaKey(t, n);
		l[o] ? l[o].push(a) : l[o] = [a];
	}), {
		inlinePrimaryKeyMap: c,
		compositePrimaryKeyMap: l
	};
}
async function validateDatasetIdList(e, t) {
	let [n] = await e.getDatasets(), r = n.map((e) => e.id).filter((e) => e);
	return t.length === 0 ? r : getIntersection(t, r);
}
async function fetchSchemaJsonByDataset(e, t, n) {
	let r = await Promise.all([
		generateTablesAndFields$4(e, t, n),
		generateIndexes$3(e, t, n),
		generateTableConstraints(e, t, n)
	]), { tables: i, fieldMap: a } = r[0], o = r[1], { inlinePrimaryKeyMap: s, compositePrimaryKeyMap: c } = r[2];
	return {
		tables: i,
		fields: a,
		refs: [],
		enums: [],
		indexes: mergeIndexDictionary(o, c),
		tableConstraints: s,
		checks: {}
	};
}
async function fetchSchemaJson(e) {
	let t = parseBigQueryCredential(await loadCredentialFromFile(e)), n = await connectBigQuery(t), r = await n.getProjectId(), i = (await validateDatasetIdList(n, t.datasets)).map((e) => fetchSchemaJsonByDataset(n, r, e));
	return (await Promise.all(i)).reduce((e, t) => {
		let { tables: n, fields: r, indexes: i, tableConstraints: a } = t;
		return e.tables = mergeTables(e.tables, n), e.fields = mergeFieldDictionary(e.fields, r), e.indexes = mergeIndexDictionary(e.indexes, i), e.tableConstraints = mergeTableConstraintDictionary(e.tableConstraints, a), e;
	}, {
		tables: [],
		fields: {},
		tableConstraints: {},
...
var SCHEMAS_DELIMITER = "schemas=", haveSchemas = (e) => e.toLowerCase().includes(SCHEMAS_DELIMITER), getSchemasPart = (e) => e ? e.toLowerCase().split(SCHEMAS_DELIMITER)[1] : "", noSchemaResult = (e) => ({
	connectionString: e,
	schemas: []
});
const parseSchema = (e) => e ? e.split(/,(?=(?:[^"]*(?:"[^"]*")*)*$)/).map((e) => e.trim()).map((e) => e.replace(/"/g, "")) : [];
var parseOdbcSchema = (e) => {
	let t = e.split(";"), n = t.find((e) => haveSchemas(e));
	return {
		connectionString: t.filter((e) => !haveSchemas(e)).join(";"),
		schemas: parseSchema(getSchemasPart(n))
	};
};
const parseJdbcSchema = (e) => {
	let t = e.split("?"), n = t[1].split("&").find((e) => haveSchemas(e));
	return {
		connectionString: t[0],
		schemas: parseSchema(getSchemasPart(n))
	};
}, parseConnectionString$1 = (e, t) => haveSchemas(e) ? t === "jdbc" ? parseJdbcSchema(e) : parseOdbcSchema(e) : noSchemaResult(e), buildSchemaQuery = (e, t, n = "AND") => t.length === 0 ? "" : `${n} ${e} IN (${t.map((e) => `'${e}'`).join(", ")})`;
var MSSQL_DATE_TYPES = [
	"date",
	"datetime",
	"datetime2",
	"smalldatetime",
	"datetimeoffset",
	"time"
], getValidatedClient$2 = async (e) => {
	let t = await sql.connect(e);
	try {
		return await t.request().query("SELECT 1"), t;
	} catch (e) {
		throw t.connected && await t.close(), e instanceof Error ? Error(`SQL connection error: ${e.message}`) : e;
	}
}, convertQueryBoolean$2 = (e) => e === "YES", getFieldType$4 = (e, t, n, r) => MSSQL_DATE_TYPES.includes(e) || e === "timestamp" || e === "bit" ? e : n ? r ? `${e}(${n},${r})` : `${e}(${n})` : [
	"ntext",
	"text",
	"image"
].includes(e) ? e : t < 0 ? e === "xml" ? e : `${e}(MAX)` : t > 0 ? `${e}(${e === "nchar" || e === "nvarchar" ? t / 2 : t})` : e, getDbdefault$3 = (e, t, n) => {
	let r = t.slice(1, -1).replace(/\(([^()]+)\)/g, "$1");
	return {
		type: n,
		value: n === "string" ? r.slice(1, -1) : r
	};
}, generateField$4 = (e) => {
	let { column_name: t, data_type: n, character_maximum_length: r, numeric_precision: i, numeric_scale: a, identity_increment: o, is_nullable: s, column_default: c, default_type: l, column_comment: u } = e, d = c && l !== "increment" ? getDbdefault$3(n, c, l) : null;
	return {
		name: t,
		type: {
			type_name: getFieldType$4(n, r, i, a),
			schemaName: null
		},
		dbdefault: d,
		not_null: !convertQueryBoolean$2(s),
		increment: !!o,
		note: u ? { value: u } : { value: "" }
	};
}, generateTablesFields = async (e, t) => {
	let n = {}, r = `
    ...
    WHERE
      1 = 1
      ${buildSchemaQuery("table_schema", t)}
    ORDER BY
      table_schema,
      table_create_date,
      table_id,
      column_id;
  `, i = (await e.query(r)).recordset.reduce((e, t) => {
		let { table_schema: r, table_name: i, table_comment: a } = t, o = `${r}.${i}`;
		e[o] || (e[o] = {
			name: i,
			schemaName: r,
			note: a ? { value: a } : { value: "" }
		}), n[o] || (n[o] = []);
		let s = generateField$4(t);
		return n[o].push(s), e;
	}, {});
	return {
		tables: Object.values(i),
		fields: n
	};
}, generateRefs = async (e, t) => {
	let n = [], r = `
    SELECT
      s.name AS table_schema,
      t.name AS table_name,
    ...
    WHERE s.name NOT IN ('sys', 'information_schema')
      ${buildSchemaQuery("s.name", t)}
    ORDER BY
      s.name,
      t.name;
  `, i = await e.query(r), a = (e, t) => e.length === t.length ? e.every((e, n) => e.tableName === t[n].tableName && e.schemaName === t[n].schemaName && e.fieldNames.length === t[n].fieldNames.length && e.fieldNames.every((e, r) => e === t[n].fieldNames[r])) : !1;
	return i.recordset.forEach((e) => {
		let { table_schema: t, fk_constraint_name: r, table_name: i, column_names: o, foreign_table_schema: s, foreign_table_name: c, foreign_column_names: l, on_delete: u, on_update: d } = e, f = {
			name: r,
			endpoints: [{
				tableName: i,
				schemaName: t,
			...
			onDelete: u === "NO_ACTION" ? null : u,
			onUpdate: d === "NO_ACTION" ? null : d
		};
		n.some((e) => a(e.endpoints, f.endpoints)) || n.push(f);
	}), n;
}, generateIndexesAndConstraints$1 = async (e, t) => {
	let n = `
    WITH user_tables AS (
      SELECT
        TABLE_SCHEMA,
    ...
    WHERE
      ...
      ${buildSchemaQuery("ut.TABLE_SCHEMA", t)}
    ORDER BY
      ut.TABLE_NAME,
      ii.constraint_type,
      ii.index_name;
  `, { outOfLineIndexes: r, inlineIndexes: i } = (await e.query(n)).recordset.reduce((e, t) => {
		let { constraint_type: n, columns: r } = t;
		return r === "null" || r.trim() === "" || (n === "PRIMARY KEY" || n === "UNIQUE" ? e.inlineIndexes.push(t) : e.outOfLineIndexes.push(t)), e;
	}, {
		inlineIndexes: [],
		outOfLineIndexes: []
	}), a = r.reduce((e, t) => {
		let { table_schema: n, table_name: r, index_name: i, index_type: a, columns: o, expressions: s, is_unique: c, is_primary: l } = t, u = o.split(",").map((e) => ({
			type: "column",
			value: e.trim()
		})), d = s ? s.split(",").map((e) => ({
			type: "expression",
		...
		return e[p] ? e[p].push(f) : e[p] = [f], e;
	}, {}), o = {};
	i.forEach((e) => {
		let { table_schema: t, table_name: n, columns: r, constraint_type: i } = e, a = `${t}.${n}`;
		o[a] || (o[a] = {}), r.split(",").map((e) => e.trim()).forEach((e) => {
			o[a][e] || (o[a][e] = { checks: [] }), i === "PRIMARY KEY" && (o[a][e].pk = !0), i === "UNIQUE" && !o[a][e].pk && (o[a][e].unique = !0);
		});
	});
	let s = `
    SELECT
    ...
    WHERE 1 = 1
      ${buildSchemaQuery("OBJECT_SCHEMA_NAME(cc.parent_object_id)", t)}
  `, c = await e.query(s), l = {};
	return c.recordset.forEach((e) => {
		let { table_schema: t, table_name: n, column_name: r, check_name: i, check_expression: a } = e, s = `${t}.${n}`;
		if (a) {
			if (r) {
				o[s] || (o[s] = {}), o[s][r] || (o[s][r] = { checks: [] }), o[s][r].checks.push({
					name: i,
					expression: a.slice(1, -1)
				});
				return;
			}
			l[s] || (l[s] = []), l[s].push({
...
}, fetchSchemaJson$1 = async (e) => {
	let { connectionString: t, schemas: n } = parseConnectionString$1(e, "odbc"), r = await getValidatedClient$2(t);
	try {
		let e = generateTablesFields(r, n), t = generateIndexesAndConstraints$1(r, n), i = generateRefs(r, n), a = await Promise.all([
			e,
			t,
			i
		]), { tables: o, fields: s } = a[0], { indexes: c, tableConstraints: l, checks: u } = a[1];
		return {
			tables: o,
			fields: s,
			enums: [],
...
}, _freeGlobal_default = typeof global == "object" && global && global.Object === Object && global, freeSelf = typeof self == "object" && self && self.Object === Object && self, _Symbol_default = (_freeGlobal_default || freeSelf || Function("return this")()).Symbol, objectProto$1 = Object.prototype, hasOwnProperty$1 = objectProto$1.hasOwnProperty, nativeObjectToString$1 = objectProto$1.toString, symToStringTag$1 = _Symbol_default ? _Symbol_default.toStringTag : void 0;
function getRawTag(e) {
	var t = hasOwnProperty$1.call(e, symToStringTag$1), n = e[symToStringTag$1];
	try {
...
var isObjectLike_default = isObjectLike, isArray_default = Array.isArray, argsTag = "[object Arguments]";
function baseIsArguments(e) {
	return isObjectLike_default(e) && _baseGetTag_default(e) == argsTag;
}
var _baseIsArguments_default = baseIsArguments, objectProto = Object.prototype, hasOwnProperty = objectProto.hasOwnProperty, propertyIsEnumerable = objectProto.propertyIsEnumerable, isArguments_default = _baseIsArguments_default(function() {
	return arguments;
}()) ? _baseIsArguments_default : function(e) {
	return isObjectLike_default(e) && hasOwnProperty.call(e, "callee") && !propertyIsEnumerable.call(e, "callee");
};
...
var flatten_default = flatten, require_SqlString = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = e, n = /`/g, r = /\./g, i = /[\0\b\t\n\r\x1a\"\'\\]/g, a = {
		"\0": "\\0",
		"\b": "\\b",
		"	": "\\t",
		"\n": "\\n",
	...
	t.escapeId = function(e, i) {
		if (Array.isArray(e)) {
			for (var a = "", o = 0; o < e.length; o++) a += (o === 0 ? "" : ", ") + t.escapeId(e[o], i);
			return a;
		} else if (i) return "`" + String(e).replace(n, "``") + "`";
		else return "`" + String(e).replace(n, "``").replace(r, "`.`") + "`";
	}, t.escape = function(e, n, r) {
		if (e == null) return "NULL";
		switch (typeof e) {
			case "boolean": return e ? "true" : "false";
			case "number": return e + "";
			case "object": return Object.prototype.toString.call(e) === "[object Date]" ? t.dateToString(e, r || "local") : Array.isArray(e) ? t.arrayToList(e, r) : Buffer.isBuffer(e) ? t.bufferToString(e) : typeof e.toSqlString == "function" ? String(e.toSqlString()) : n ? o(e.toString()) : t.objectToValues(e, r);
			default: return o(e);
		}
	}, t.arrayToList = function(e, n) {
		for (var r = "", i = 0; i < e.length; i++) {
			var a = e[i];
			Array.isArray(a) ? r += (i === 0 ? "" : ", ") + "(" + t.arrayToList(a, n) + ")" : r += (i === 0 ? "" : ", ") + t.escape(a, !0, n);
		}
		return r;
	}, t.format = function(e, n, r, i) {
		if (n == null) return e;
		Array.isArray(n) || (n = [n]);
		for (var a = 0, o = /\?+/g, s = "", c = 0, l; c < n.length && (l = o.exec(e));) {
			var u = l[0].length;
			if (!(u > 2)) {
				var d = u === 2 ? t.escapeId(n[c]) : t.escape(n[c], r, i);
				s += e.slice(a, l.index) + d, a = o.lastIndex, c++;
			}
		}
		return a === 0 ? e : a < e.length ? s + e.slice(a) : s;
	}, t.dateToString = function(e, t) {
		var n = new Date(e);
		if (isNaN(n.getTime())) return "NULL";
		var r, i, a, l, u, d, f;
		if (t === "local") r = n.getFullYear(), i = n.getMonth() + 1, a = n.getDate(), l = n.getHours(), u = n.getMinutes(), d = n.getSeconds(), f = n.getMilliseconds();
		else {
			var p = c(t);
			p !== !1 && p !== 0 && n.setTime(n.getTime() + p * 6e4), r = n.getUTCFullYear(), i = n.getUTCMonth() + 1, a = n.getUTCDate(), l = n.getUTCHours(), u = n.getUTCMinutes(), d = n.getUTCSeconds(), f = n.getUTCMilliseconds();
		}
		return o(s(r, 4) + "-" + s(i, 2) + "-" + s(a, 2) + " " + s(l, 2) + ":" + s(u, 2) + ":" + s(d, 2) + "." + s(f, 3));
	}, t.bufferToString = function(e) {
		return "X" + o(e.toString("hex"));
	}, t.objectToValues = function(e, n) {
		var r = "";
		for (var i in e) {
			var a = e[i];
			typeof a != "function" && (r += (r.length === 0 ? "" : ", ") + t.escapeId(i) + " = " + t.escape(a, !0, n));
		}
		return r;
	}, t.raw = function(e) {
		if (typeof e != "string") throw TypeError("argument sql must be a string");
		return { toSqlString: function() {
			return e;
		} };
	};
	function o(e) {
		for (var t = i.lastIndex = 0, n = "", r; r = i.exec(e);) n += e.slice(t, r.index) + a[r[0]], t = i.lastIndex;
		return t === 0 ? "'" + e + "'" : t < e.length ? "'" + n + e.slice(t) + "'" : "'" + n + "'";
	}
	function s(e, t) {
	...
	function c(e) {
		...
		return t ? (t[1] === "-" ? -1 : 1) * (parseInt(t[2], 10) + (t[3] ? parseInt(t[3], 10) : 0) / 60) * 60 : !1;
	}
})), require_sqlstring = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = require_SqlString();
})), require_events = /* @__PURE__ */ __commonJSMin(((e, t) => {
...
})), require_denque = /* @__PURE__ */ __commonJSMin(((e, t) => {
	function n(e, t) {
		var t = t || {};
...
})), require_cjs = /* @__PURE__ */ __commonJSMin(((e) => {
	Object.defineProperty(e, "__esModule", { value: !0 }), e.LRUCache = void 0;
	var t = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, n = /* @__PURE__ */ new Set(), r = (e, t, n, r) => {
		typeof process == "object" && process && typeof process.emitWarning == "function" ? process.emitWarning(e, t, n, r) : console.error(`[${n}] ${t}: ${e}`);
	}, i = (e) => !n.has(e), a = (e) => e && e === Math.floor(e) && e > 0 && isFinite(e), o = (e) => a(e) ? e <= 2 ** 8 ? Uint8Array : e <= 2 ** 16 ? Uint16Array : e <= 2 ** 32 ? Uint32Array : e <= 2 ** 53 - 1 ? s : null : null, s = class extends Array {
		constructor(e) {
			super(e), this.fill(0);
		}
	}, c = class e {
		...
		static unsafeExposeInternals(e) {
			return {
				...
				backgroundFetch: (t, n, r, i) => e.#F(t, n, r, i),
				moveToTail: (t) => e.#R(t),
				indexes: (t) => e.#j(t),
				rindexes: (t) => e.#M(t),
				isStale: (t) => e.#E(t)
		...
		constructor(t) {
			let { max: s = 0, ttl: l, ttlResolution: u = 1, ttlAutopurge: d, updateAgeOnGet: f, updateAgeOnHas: p, allowStale: m, dispose: h, disposeAfter: g, noDisposeOnSet: _, noUpdateTTL: v, maxSize: y = 0, maxEntrySize: b = 0, sizeCalculation: x, fetchMethod: S, noDeleteOnFetchRejection: C, noDeleteOnStaleGet: w, allowStaleOnFetchRejection: T, allowStaleOnFetchAbort: E, ignoreFetchAbort: D } = t;
			if (s !== 0 && !a(s)) throw TypeError("max option must be a nonnegative integer");
			let O = s ? o(s) : Array;
			if (!O) throw Error("invalid max value: " + s);
			if (this.#e = s, this.#t = y, this.maxEntrySize = b || this.#t, this.sizeCalculation = x, this.sizeCalculation) {
			...
			if (S !== void 0 && typeof S != "function") throw TypeError("fetchMethod must be a function if specified");
			if (this.#i = S, this.#b = !!S, this.#s = /* @__PURE__ */ new Map(), this.#c = Array(s).fill(void 0), this.#l = Array(s).fill(void 0), this.#u = new O(s), this.#d = new O(s), this.#f = 0, this.#p = 0, this.#m = c.create(s), this.#a = 0, this.#o = 0, typeof h == "function" && (this.#n = h), typeof g == "function" ? (this.#r = g, this.#h = []) : (this.#r = void 0, this.#h = void 0), this.#y = !!this.#n, this.#x = !!this.#r, this.noDisposeOnSet = !!_, this.noUpdateTTL = !!v, this.noDeleteOnFetchRejection = !!C, this.allowStaleOnFetchRejection = !!T, this.allowStaleOnFetchAbort = !!E, this.ignoreFetchAbort = !!D, this.maxEntrySize !== 0) {
				if (this.#t !== 0 && !a(this.#t)) throw TypeError("maxSize must be a positive integer if specified");
				if (!a(this.maxEntrySize)) throw TypeError("maxEntrySize must be a positive integer if specified");
				this.#D();
			}
			if (this.allowStale = !!m, this.noDeleteOnStaleGet = !!w, this.updateAgeOnGet = !!f, this.updateAgeOnHas = !!p, this.ttlResolution = a(u) || u === 0 ? u : 1, this.ttlAutopurge = !!d, this.ttl = l || 0, this.ttl) {
				if (!a(this.ttl)) throw TypeError("ttl must be a positive integer if specified");
				this.#S();
			}
			...
			if (!this.ttlAutopurge && !this.#e && !this.#t) {
				...
				i(t) && (n.add(t), r("TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.", "UnboundedCacheWarning", t, e));
			}
		}
		getRemainingTTL(e) {
		...
		#S() {
			let e = new s(this.#e), n = new s(this.#e);
			this.#v = e, this.#_ = n, this.#T = (r, i, a = t.now()) => {
				if (n[r] = i === 0 ? 0 : a, e[r] = i, i !== 0 && this.ttlAutopurge) {
					let e = setTimeout(() => {
						this.#E(r) && this.delete(this.#c[r]);
					}, i + 1);
					/* c8 ignore start */
					e.unref && e.unref();
				}
				...
				if (e[a]) {
					let o = e[a], s = n[a];
					t.ttl = o, t.start = s, t.now = r || i(), t.remainingTTL = t.now + o - s;
				}
			};
			let r = 0, i = () => {
				let e = t.now();
			...
			this.getRemainingTTL = (t) => {
				let a = this.#s.get(t);
				return a === void 0 ? 0 : e[a] === 0 || n[a] === 0 ? Infinity : n[a] + e[a] - (r || i());
			}, this.#E = (t) => e[t] !== 0 && n[t] !== 0 && (r || i()) - n[t] > e[t];
		}
		#C = () => {};
		#w = () => {};
		#T = () => {};
		...
		#D() {
			let e = new s(this.#e);
			this.#o = 0, this.#g = e, this.#O = (t) => {
				this.#o -= e[t], e[t] = 0;
			}, this.#A = (e, t, n, r) => {
				if (this.#I(t)) return 0;
				if (!a(n)) if (r) {
					if (typeof r != "function") throw TypeError("sizeCalculation must be a function");
					if (n = r(t, e), !a(n)) throw TypeError("sizeCalculation return invalid (expect positive integer)");
				...
				if (e[t] = n, this.#t) {
					let n = this.#t - e[t];
					for (; this.#o > n;) this.#P(!0);
				}
				this.#o += e[t], r && (r.entrySize = n, r.totalCalculatedSize = this.#o);
			};
		}
		#O = (e) => {};
		#k = (e, t, n) => {};
		...
		*#j({ allowStale: e = this.allowStale } = {}) {
			if (this.#a) for (let t = this.#p; !(!this.#N(t) || ((e || !this.#E(t)) && (yield t), t === this.#f));) t = this.#d[t];
		}
		*#M({ allowStale: e = this.allowStale } = {}) {
			if (this.#a) for (let t = this.#f; !(!this.#N(t) || ((e || !this.#E(t)) && (yield t), t === this.#p));) t = this.#u[t];
		}
		#N(e) {
			return e !== void 0 && this.#s.get(this.#c[e]) === e;
		}
		*entries() {
			for (let e of this.#j()) this.#l[e] !== void 0 && this.#c[e] !== void 0 && !this.#I(this.#l[e]) && (yield [this.#c[e], this.#l[e]]);
		}
		*rentries() {
			for (let e of this.#M()) this.#l[e] !== void 0 && this.#c[e] !== void 0 && !this.#I(this.#l[e]) && (yield [this.#c[e], this.#l[e]]);
		}
		*keys() {
			for (let e of this.#j()) {
				let t = this.#c[e];
				t !== void 0 && !this.#I(this.#l[e]) && (yield t);
			}
		}
		*rkeys() {
			for (let e of this.#M()) {
		...
		*values() {
			for (let e of this.#j()) this.#l[e] !== void 0 && !this.#I(this.#l[e]) && (yield this.#l[e]);
		}
		*rvalues() {
			for (let e of this.#M()) this.#l[e] !== void 0 && !this.#I(this.#l[e]) && (yield this.#l[e]);
		}
		[Symbol.iterator]() {
			return this.entries();
		}
		find(e, t = {}) {
			for (let n of this.#j()) {
				let r = this.#l[n], i = this.#I(r) ? r.__staleWhileFetching : r;
				if (i !== void 0 && e(i, this.#c[n], this)) return this.get(this.#c[n], t);
			}
		}
		forEach(e, t = this) {
			for (let n of this.#j()) {
				let r = this.#l[n], i = this.#I(r) ? r.__staleWhileFetching : r;
				i !== void 0 && e.call(t, i, this.#c[n], this);
			}
		}
		rforEach(e, t = this) {
			for (let n of this.#M()) {
		...
		purgeStale() {
			let e = !1;
			for (let t of this.#M({ allowStale: !0 })) this.#E(t) && (this.delete(this.#c[t]), e = !0);
			return e;
		}
		dump() {
			let e = [];
			for (let n of this.#j({ allowStale: !0 })) {
				let r = this.#c[n], i = this.#l[n], a = this.#I(i) ? i.__staleWhileFetching : i;
				if (a === void 0 || r === void 0) continue;
				let o = { value: a };
				if (this.#v && this.#_) {
					o.ttl = this.#v[n];
					let e = t.now() - this.#_[n];
					o.start = Math.floor(Date.now() - e);
				}
				this.#g && (o.size = this.#g[n]), e.unshift([r, o]);
			}
			return e;
		}
		load(e) {
		...
		set(e, t, n = {}) {
			let { ttl: r = this.ttl, start: i, noDisposeOnSet: a = this.noDisposeOnSet, sizeCalculation: o = this.sizeCalculation, status: s } = n, { noUpdateTTL: c = this.noUpdateTTL } = n, l = this.#A(e, t, n.size || 0, o);
			if (this.maxEntrySize && l > this.maxEntrySize) return s && (s.set = "miss", s.maxEntrySizeExceeded = !0), this.delete(e), this;
			let u = this.#a === 0 ? void 0 : this.#s.get(e);
			if (u === void 0) u = this.#a === 0 ? this.#p : this.#m.length === 0 ? this.#a === this.#e ? this.#P(!1) : this.#a : this.#m.pop(), this.#c[u] = e, this.#l[u] = t, this.#s.set(e, u), this.#u[this.#p] = u, this.#d[u] = this.#p, this.#p = u, this.#a++, this.#k(u, l, s), s && (s.set = "add"), c = !1;
			else {
				this.#R(u);
				let n = this.#l[u];
				if (t !== n) {
					if (this.#b && this.#I(n) ? n.__abortController.abort(/* @__PURE__ */ Error("replaced")) : a || (this.#y && this.#n?.(n, e, "set"), this.#x && this.#h?.push([
						n,
						e,
						"set"
					])), this.#O(u), this.#k(u, l, s), this.#l[u] = t, s) {
						s.set = "replace";
						let e = n && this.#I(n) ? n.__staleWhileFetching : n;
						e !== void 0 && (s.oldValue = e);
					}
				} else s && (s.set = "update");
			}
			if (r !== 0 && !this.#v && this.#S(), this.#v && (c || this.#T(u, r, i), s && this.#w(s, u)), !a && this.#x && this.#h) {
				let e = this.#h, t;
		...
		#P(e) {
			let t = this.#f, n = this.#c[t], r = this.#l[t];
			return this.#b && this.#I(r) ? r.__abortController.abort(/* @__PURE__ */ Error("evicted")) : (this.#y || this.#x) && (this.#y && this.#n?.(r, n, "evict"), this.#x && this.#h?.push([
				r,
				n,
				"evict"
			])), this.#O(t), e && (this.#c[t] = void 0, this.#l[t] = void 0, this.#m.push(t)), this.#a === 1 ? (this.#f = this.#p = 0, this.#m.length = 0) : this.#f = this.#u[t], this.#s.delete(n), this.#a--, t;
		}
		has(e, t = {}) {
			let { updateAgeOnHas: n = this.updateAgeOnHas, status: r } = t, i = this.#s.get(e);
			if (i !== void 0) {
				let e = this.#l[i];
				if (this.#I(e) && e.__staleWhileFetching === void 0) return !1;
				if (this.#E(i)) r && (r.has = "stale", this.#w(r, i));
				else return n && this.#C(i), r && (r.has = "hit", this.#w(r, i)), !0;
			} else r && (r.has = "miss");
			return !1;
		}
		peek(e, t = {}) {
			let { allowStale: n = this.allowStale } = t, r = this.#s.get(e);
			if (r !== void 0 && (n || !this.#E(r))) {
				let e = this.#l[r];
				return this.#I(e) ? e.__staleWhileFetching : e;
			}
		}
		#F(e, t, n, r) {
			let i = t === void 0 ? void 0 : this.#l[t];
			...
			let s = {
				...
				let l = f;
				return this.#l[t] === f && (r === void 0 ? l.__staleWhileFetching ? this.#l[t] = l.__staleWhileFetching : this.delete(e) : (n.status && (n.status.fetchUpdated = !0), this.set(e, r, s.options))), r;
				...
				if (this.#l[t] === f && (!c || l.__staleWhileFetching === void 0 ? this.delete(e) : o || (this.#l[t] = l.__staleWhileFetching)), s) return n.status && l.__staleWhileFetching !== void 0 && (n.status.returnedStale = !0), l.__staleWhileFetching;
				if (l.__returned === l) throw r;
			}, d = (t, r) => {
				let o = this.#i?.(e, i, s);
				o && o instanceof Promise && o.then((e) => t(e), r), a.signal.addEventListener("abort", () => {
					(!n.ignoreFetchAbort || n.allowStaleOnFetchAbort) && (t(), n.allowStaleOnFetchAbort && (t = (e) => c(e, !0)));
				});
			};
		...
		async fetch(e, t = {}) {
			...
			if (!this.#b) return g && (g.fetch = "get"), this.get(e, {
				allowStale: n,
				updateAgeOnGet: r,
			...
			if (y === void 0) {
				...
				let i = this.#E(y);
				if (!h && !i) return g && (g.fetch = "hit"), this.#R(y), r && this.#C(y), g && this.#w(g, y), t;
				let a = this.#F(e, y, v, m), o = a.__staleWhileFetching !== void 0 && n;
				return g && (g.fetch = i ? "stale" : "refresh", o && i && (g.returnedStale = !0)), o ? a.__staleWhileFetching : a.__returned = a;
			}
		}
		get(e, t = {}) {
			let { allowStale: n = this.allowStale, updateAgeOnGet: r = this.updateAgeOnGet, noDeleteOnStaleGet: i = this.noDeleteOnStaleGet, status: a } = t, o = this.#s.get(e);
			if (o !== void 0) {
				let t = this.#l[o], s = this.#I(t);
				return a && this.#w(a, o), this.#E(o) ? (a && (a.get = "stale"), s ? (a && n && t.__staleWhileFetching !== void 0 && (a.returnedStale = !0), n ? t.__staleWhileFetching : void 0) : (i || this.delete(e), a && n && (a.returnedStale = !0), n ? t : void 0)) : (a && (a.get = "hit"), s ? t.__staleWhileFetching : (this.#R(o), r && this.#C(o), t));
			} else a && (a.get = "miss");
		}
		#L(e, t) {
			this.#d[t] = e, this.#u[e] = t;
		}
		#R(e) {
			e !== this.#p && (e === this.#f ? this.#f = this.#u[e] : this.#L(this.#d[e], this.#u[e]), this.#L(this.#p, e), this.#p = e);
		}
		delete(e) {
			let t = !1;
			if (this.#a !== 0) {
				let n = this.#s.get(e);
				if (n !== void 0) if (t = !0, this.#a === 1) this.clear();
				else {
					this.#O(n);
					let t = this.#l[n];
					this.#I(t) ? t.__abortController.abort(/* @__PURE__ */ Error("deleted")) : (this.#y || this.#x) && (this.#y && this.#n?.(t, e, "delete"), this.#x && this.#h?.push([
						t,
						e,
						"delete"
					])), this.#s.delete(e), this.#c[n] = void 0, this.#l[n] = void 0, n === this.#p ? this.#p = this.#d[n] : n === this.#f ? this.#f = this.#u[n] : (this.#u[this.#d[n]] = this.#u[n], this.#d[this.#u[n]] = this.#d[n]), this.#a--, this.#m.push(n);
				}
			}
		...
		clear() {
			for (let e of this.#M({ allowStale: !0 })) {
				let t = this.#l[e];
				if (this.#I(t)) t.__abortController.abort(/* @__PURE__ */ Error("deleted"));
				else {
					let n = this.#c[e];
					this.#y && this.#n?.(t, n, "delete"), this.#x && this.#h?.push([
						t,
						n,
						"delete"
					]);
			...
			if (this.#s.clear(), this.#l.fill(void 0), this.#c.fill(void 0), this.#v && this.#_ && (this.#v.fill(0), this.#_.fill(0)), this.#g && this.#g.fill(0), this.#f = 0, this.#p = 0, this.#m.length = 0, this.#o = 0, this.#a = 0, this.#x && this.#h) {
				let e = this.#h, t;
				for (; t = e?.shift();) this.#r?.(...t);
			}
		}
	};
	e.LRUCache = l, e.default = l;
})), require_index_cjs = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = (e && e.__importDefault || function(e) {
		return e && e.__esModule ? e : { default: e };
	})(require_cjs());
	t.exports = Object.assign(n.default, {
		default: n.default,
		LRUCache: n.default
	});
...
})), require_base64_js = /* @__PURE__ */ __commonJSMin(((e) => {
...
})), require_ieee754 = /* @__PURE__ */ __commonJSMin(((e) => {
...
})), require_buffer = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_base64_js(), n = require_ieee754(), r = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
	...
	function b(e, t, n) {
		...
		for (e ||= "utf8";;) switch (e) {
			...
			case "latin1":
			case "binary": return Ei(this, t, n);
			case "base64": return k(this, t, n);
			case "ucs2":
			case "ucs-2":
			case "utf16le":
			case "utf-16le": return Di(this, t, n);
			default:
	...
	function O(e, t, n, r) {
		return X(Mi(t, e.length - n), e, n, r);
	}
	...
	function q(e, t, n) {
		throw Math.floor(e) === e ? t < 0 ? new H.ERR_BUFFER_OUT_OF_BOUNDS() : new H.ERR_OUT_OF_RANGE(n || "offset", `>= ${n ? 1 : 0} and <= ${t}`, e) : (K(e, n), new H.ERR_OUT_OF_RANGE(n || "offset", "an integer", e));
	}
	var ki = /[^+/0-9A-Za-z-_]/g;
	function Ai(e) {
		if (e = e.split("=")[0], e = e.trim().replace(ki, ""), e.length < 2) return "";
		for (; e.length % 4 != 0;) e += "=";
		return e;
	}
	function J(e, t) {
	...
	function $(e) {
		return typeof BigInt > "u" ? Pi : e;
	}
	function Pi() {
		throw Error("BigInt not supported");
	}
})), require_umd = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = (function(e) {
		...
		*/
		...
		}, e.default = n, "default" in e ? e.default : e;
	})({});
	typeof define == "function" && define.amd ? define([], function() {
		return n;
	}) : typeof t == "object" && typeof e == "object" && (t.exports = n);
})), require_safer = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_buffer(), r = n.Buffer, i = {}, a;
	for (a in n) n.hasOwnProperty(a) && (a === "SlowBuffer" || a === "Buffer" || (i[a] = n[a]));
	var o = i.Buffer = {};
	for (a in r) r.hasOwnProperty(a) && (a === "allocUnsafe" || a === "allocUnsafeSlow" || (o[a] = r[a]));
	if (i.Buffer.prototype = r.prototype, (!o.from || o.from === Uint8Array.from) && (o.from = function(e, t, n) {
		...
		var i = r(e);
		return !t || t.length === 0 ? i.fill(0) : typeof n == "string" ? i.fill(t, n) : i.fill(t), i;
	}, !i.kStringMaxLength) try {
		i.kStringMaxLength = process.binding("buffer").kStringMaxLength;
	} catch {}
	i.constants || (i.constants = { MAX_LENGTH: i.kMaxLength }, i.kStringMaxLength && (i.constants.MAX_STRING_LENGTH = i.kStringMaxLength)), t.exports = i;
})), require_bom_handling = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = "﻿";
	e.PrependBOM = n;
	function n(e, t) {
...
})), require_safe_buffer = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_buffer(), r = n.Buffer;
	function i(e, t) {
...
})), require_string_decoder = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_safe_buffer().Buffer, n = t.isEncoding || function(e) {
...
})), require_internal = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_safer().Buffer;
	t.exports = {
		utf8: {
			type: "_internal",
			bomAware: !0
	...
	function r(e, t) {
		this.enc = e.encodingName, this.bomAware = e.bomAware, this.enc === "base64" ? this.encoder = s : this.enc === "cesu8" && (this.enc = "utf8", this.encoder = c, n.from("eda0bdedb2a9", "hex").toString() !== "💩" && (this.decoder = l, this.defaultCharUnicode = t.defaultCharUnicode));
	}
	r.prototype.encoder = o, r.prototype.decoder = a;
	var i = require_string_decoder().StringDecoder;
	...
	c.prototype.write = function(e) {
		for (var t = n.alloc(e.length * 3), r = 0, i = 0; i < e.length; i++) {
			var a = e.charCodeAt(i);
			a < 128 ? t[r++] = a : a < 2048 ? (t[r++] = 192 + (a >>> 6), t[r++] = 128 + (a & 63)) : (t[r++] = 224 + (a >>> 12), t[r++] = 128 + (a >>> 6 & 63), t[r++] = 128 + (a & 63));
		}
		return t.slice(0, r);
...
})), require_utf32 = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_safer().Buffer;
	e._utf32 = n;
	function n(e, t) {
	...
	r.prototype.write = function(e) {
		for (var n = t.from(e, "ucs2"), r = t.alloc(n.length * 2), i = this.isLE ? r.writeUInt32LE : r.writeUInt32BE, a = 0, o = 0; o < n.length; o += 2) {
			var s = n.readUInt16LE(o), c = 55296 <= s && s < 56320, l = 56320 <= s && s < 57344;
	...
	i.prototype.write = function(e) {
		...
		if (c.length > 0) {
			...
			c.length === 4 && (r = s ? c[n] | c[n + 1] << 8 | c[n + 2] << 16 | c[n + 3] << 24 : c[n + 3] | c[n + 2] << 8 | c[n + 1] << 16 | c[n] << 24, c.length = 0, o = a(i, o, r, l));
		}
	...
	function l(e, t) {
		...
		outer_loop: for (var c = 0; c < e.length; c++) for (var l = e[c], u = 0; u < l.length; u++) if (n.push(l[u]), n.length === 4) {
			if (r === 0) {
				if (n[0] === 255 && n[1] === 254 && n[2] === 0 && n[3] === 0) return "utf-32le";
				if (n[0] === 0 && n[1] === 0 && n[2] === 254 && n[3] === 255) return "utf-32be";
			}
			if ((n[0] !== 0 || n[1] > 16) && a++, (n[3] !== 0 || n[2] > 16) && i++, n[0] === 0 && n[1] === 0 && (n[2] !== 0 || n[3] !== 0) && s++, (n[0] !== 0 || n[1] !== 0) && n[2] === 0 && n[3] === 0 && o++, n.length = 0, r++, r >= 100) break outer_loop;
		}
		return s - a > o - i ? "utf-32be" : s - a < o - i ? "utf-32le" : t || "utf-32le";
	}
})), require_utf16 = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_safer().Buffer;
	e.utf16be = n;
	function n() {}
	...
	function c(e, t) {
		var n = [], r = 0, i = 0, a = 0;
		outer_loop: for (var o = 0; o < e.length; o++) for (var s = e[o], c = 0; c < s.length; c++) if (n.push(s[c]), n.length === 2) {
			if (r === 0) {
				if (n[0] === 255 && n[1] === 254) return "utf-16le";
				if (n[0] === 254 && n[1] === 255) return "utf-16be";
			}
			if (n[0] === 0 && n[1] !== 0 && a++, n[0] !== 0 && n[1] === 0 && i++, n.length = 0, r++, r >= 100) break outer_loop;
		}
		return a > i ? "utf-16be" : a < i ? "utf-16le" : t || "utf-16le";
	}
})), require_utf7 = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_safer().Buffer;
	...
	p.prototype.write = function(e) {
		for (var n = this.inBase64, r = this.base64Accum, i = this.base64AccumIdx, a = t.alloc(e.length * 5 + 10), o = 0, s = 0; s < e.length; s++) {
			...
			32 <= c && c <= 126 ? (n &&= (i > 0 && (o += a.write(r.slice(0, i).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), o), i = 0), a[o++] = u, !1), n || (a[o++] = c, c === d && (a[o++] = u))) : (n ||= (a[o++] = d, !0), n && (r[i++] = c >> 8, r[i++] = c & 255, i == r.length && (o += a.write(r.toString("base64").replace(/\//g, ","), o), i = 0)));
		}
...
})), require_sbcs_codec = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_safer().Buffer;
	e._sbcs = n;
	function n(e, n) {
...
})), require_sbcs_data = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
		10029: "maccenteuro",
		maccenteuro: {
			type: "_sbcs",
...
})), require_sbcs_data_generated = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
		437: "cp437",
		737: "cp737",
		775: "cp775",
...
})), require_dbcs_codec = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_safer().Buffer;
	e._dbcs = l;
		...
		for (var r = 1; r < e.length; r++) {
			...
			if (typeof a == "string") for (var o = 0; o < a.length;) {
				...
				if (55296 <= s && s < 56320) {
					...
					if (56320 <= c && c < 57344) n[t++] = 65536 + (s - 55296) * 1024 + (c - 56320);
	...
	u.prototype.write = function(e) {
		for (var r = t.alloc(e.length * (this.gb18030 ? 4 : 3)), a = this.leadSurrogate, o = this.seqObj, c = -1, l = 0, u = 0;;) {
			...
			if (55296 <= d && d < 57344) if (d < 56320) if (a === -1) {
				a = d;
				continue;
			} else a = d, d = n;
			...
			if (o !== void 0 && d != n) {
				...
				if (typeof m == "object") {
					o = m;
					continue;
				} else typeof m == "number" ? p = m : m ?? (m = o[s], m !== void 0 && (p = m, c = d));
				o = void 0;
			} else if (d >= 0) {
	...
	d.prototype.write = function(e) {
		for (var o = t.alloc(e.length * 2), s = this.nodeIdx, c = this.prevBytes, l = this.prevBytes.length, u = -this.prevBytes.length, d, p = 0, m = 0; p < e.length; p++) {
			...
			if (!(d >= 0)) if (d === n) d = this.defaultCharUnicode.charCodeAt(0), p = u;
			else if (d === r) {
...
})), shiftjis_exports = /* @__PURE__ */ __export({ default: () => shiftjis_default }, 1), shiftjis_default, init_shiftjis = __esmMin((() => {
...
})), eucjp_exports = /* @__PURE__ */ __export({ default: () => eucjp_default }, 1), eucjp_default, init_eucjp = __esmMin((() => {
...
})), cp936_exports = /* @__PURE__ */ __export({ default: () => cp936_default }, 1), cp936_default, init_cp936 = __esmMin((() => {
...
})), gbk_added_exports = /* @__PURE__ */ __export({ default: () => gbk_added_default }, 1), gbk_added_default, init_gbk_added = __esmMin((() => {
	gbk_added_default = [
		[
			"a140",
			"",
...
})), gb18030_ranges_exports = /* @__PURE__ */ __export({
	default: () => gb18030_ranges_default,
	gbChars: () => gbChars,
	uChars: () => uChars
}, 1), uChars, gbChars, gb18030_ranges_default, init_gb18030_ranges = __esmMin((() => {
	uChars = [
		128,
		165,
		169,
...
})), cp949_exports = /* @__PURE__ */ __export({ default: () => cp949_default }, 1), cp949_default, init_cp949 = __esmMin((() => {
...
})), cp950_exports = /* @__PURE__ */ __export({ default: () => cp950_default }, 1), cp950_default, init_cp950 = __esmMin((() => {
...
})), big5_added_exports = /* @__PURE__ */ __export({ default: () => big5_added_default }, 1), big5_added_default, init_big5_added = __esmMin((() => {
...
})), require_dbcs_data = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
		shiftjis: {
			type: "_dbcs",
			table: function() {
...
})), require_encodings = /* @__PURE__ */ __commonJSMin(((e) => {
	for (var t = [
		require_internal(),
		require_utf32(),
		require_utf16(),
...
})), require_streams = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_safer().Buffer;
	...
	var n = require_safer().Buffer, r = require_bom_handling(), i = t.exports;
	i.encodings = null, i.defaultCharUnicode = "�", i.defaultCharSingleByte = "?", i.encode = function(e, t, r) {
		e = "" + (e || "");
		var a = i.getEncoder(t, r), o = a.write(e), s = a.end();
		return s && s.length > 0 ? n.concat([o, s]) : o;
	}, i.decode = function(e, t, r) {
		typeof e == "string" && (i.skipDecodeWarning ||= (console.error("Iconv-lite warning: decode()-ing strings is deprecated. Refer to https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding"), !0), e = n.from("" + (e || ""), "binary"));
		var a = i.getDecoder(t, r), o = a.write(e), s = a.end();
		return s ? o + s : o;
		...
		i.encodings ||= require_encodings();
		for (var t = i._canonicalizeEncoding(e), n = {};;) {
			var r = i._codecDataCache[t];
			if (r) return r;
			var a = i.encodings[t];
			switch (typeof a) {
				case "string":
				...
				case "object":
					...
					n.encodingName ||= t, t = a.type;
					break;
				case "function": return n.encodingName ||= t, r = new a(n, i), i._codecDataCache[n.encodingName] = r, r;
				default: throw Error("Encoding not recognized: '" + e + "' (searched as: '" + t + "')");
			}
		}
	}, i._canonicalizeEncoding = function(e) {
		return ("" + e).toLowerCase().replace(/:\d{4}$|[^0-9a-z]/g, "");
	}, i.getEncoder = function(e, t) {
		var n = i.getCodec(e), a = new n.encoder(t, n);
		return n.bomAware && t && t.addBOM && (a = new r.PrependBOM(a, t)), a;
	}, i.getDecoder = function(e, t) {
		var n = i.getCodec(e), a = new n.decoder(t, n);
		return n.bomAware && !(t && t.stripBOM === !1) && (a = new r.StripBOM(a, t)), a;
	}, i.enableStreamingAPI = function(e) {
		if (!i.supportsStreams) {
			var t = require_streams()(e);
			i.IconvLiteEncoderStream = t.IconvLiteEncoderStream, i.IconvLiteDecoderStream = t.IconvLiteDecoderStream, i.encodeStream = function(e, t) {
				return new i.IconvLiteEncoderStream(i.getEncoder(e, t), t);
			}, i.decodeStream = function(e, t) {
				return new i.IconvLiteDecoderStream(i.getDecoder(e, t), t);
			}, i.supportsStreams = !0;
		}
	};
	var a;
	...
	a && a.Transform ? i.enableStreamingAPI(a) : i.encodeStream = i.decodeStream = function() {
		throw Error("iconv-lite Streaming API is not enabled. Use iconv.enableStreamingAPI(require('stream')); to enable it.");
	};
})), require_string = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_lib$1(), n = require_index_cjs().default, r = new n({ max: 500 });
...
})), require_packet = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_errors(), r = require_buffer().Buffer, i = require_umd(), a = require_string(), o = /* @__PURE__ */ new Date(NaN), s = "000000000000";
	function c(e, t) {
		let n = t.toString();
		return n.length >= e ? n : (s + n).slice(-e);
	}
	var l = 45, u = 43, d = 46, f = 101, p = 69;
	t.exports = class e {
		constructor(e, t, n, r) {
		...
		readInt64JSNumber() {
			return new i(this.readInt32(), this.readInt32(), !0).toNumber();
		}
		readSInt64JSNumber() {
			let e = this.readInt32(), t = this.readInt32();
			return t & 2147483648 ? new i(e, t, !1).toNumber() : e + 4294967296 * t;
		}
		readInt64String() {
			return new i(this.readInt32(), this.readInt32(), !0).toString();
		}
		readSInt64String() {
			return new i(this.readInt32(), this.readInt32(), !1).toString();
		}
		readInt64() {
			let e = new i(this.readInt32(), this.readInt32(), !0), t = e.toNumber(), n = e.toString();
			return e = t.toString() === n ? t : n, e;
		}
		readSInt64() {
			let e = new i(this.readInt32(), this.readInt32(), !1), t = e.toNumber(), n = e.toString();
			return e = t.toString() === n ? t : n, e;
		}
		isEOF() {
		...
		readLengthCodedNumberExt(e, t, n) {
			...
			if (e === 254) {
				if (r = this.readInt32(), a = this.readInt32(), a === 0) return r;
				if (a < 2097152) return a * 4294967296 + r;
				o = new i(r, a, !n);
				let e = o.toNumber(), s = o.toString();
				return o = e.toString() === s ? e : s, t ? s : o;
			}
		...
		readDateTime(e) {
			if (!e || e === "Z" || e === "local") {
				...
				let n = 0, r = 0, i = 0, a = 0, s = 0, c = 0, l = 0;
				return t > 3 && (n = this.readInt16(), r = this.readInt8(), i = this.readInt8()), t > 6 && (a = this.readInt8(), s = this.readInt8(), c = this.readInt8()), t > 10 && (l = this.readInt32() / 1e3), n + r + i + a + s + c + l === 0 ? o : e === "Z" ? new Date(Date.UTC(n, r - 1, i, a, s, c, l)) : new Date(n, r - 1, i, a, s, c, l);
			}
			let t = this.readDateTimeString(6, "T");
			return t.length === 10 && (t += "T00:00:00"), new Date(t + e);
		}
		readDateTimeString(e, t) {
			let n = this.readInt8(), r = 0, i = 0, a = 0, o = 0, s = 0, l = 0, u = 0, d;
			return n > 3 && (r = this.readInt16(), i = this.readInt8(), a = this.readInt8(), d = [
				c(4, r),
				c(2, i),
				c(2, a)
			].join("-")), n > 6 && (o = this.readInt8(), s = this.readInt8(), l = this.readInt8(), d += `${t || " "}${[
				c(2, o),
				c(2, s),
				c(2, l)
			].join(":")}`), n > 10 && (u = this.readInt32(), d += ".", e && (u = c(6, u), u.length > e && (u = u.substring(0, e))), d += u), d;
		}
		readTimeString(e) {
			let t = this.readInt8();
		...
		readLengthCodedString(e) {
			...
			return t === null ? null : (this.offset += t, a.decode(this.buffer, e, this.offset - t, this.offset));
		}
		...
		readNullTerminatedString(e) {
			...
			for (; this.buffer[n];) n += 1;
			return this.offset = n + 1, a.decode(this.buffer, e, t, n);
		}
		readString(e, t) {
			return typeof e == "string" && t === void 0 && (t = e, e = void 0), e === void 0 && (e = this.end - this.offset), this.offset += e, a.decode(this.buffer, t, this.offset - e, this.offset);
		}
		parseInt(e, t) {
			if (e === null) return null;
			if (e >= 14 && !t) {
			...
			if (e === 0) return 0;
			this.buffer[this.offset] === l && (this.offset++, a = -1);
			let o, s = i - this.offset;
			if (t) {
				if (s >= 15) return o = this.readString(i - this.offset, "binary"), n = parseInt(o, 10), n.toString() === o ? a * n : a === -1 ? `-${o}` : o;
				if (s > 16) return o = this.readString(i - this.offset), a === -1 ? `-${o}` : o;
			}
			for (this.buffer[this.offset] === u && this.offset++; this.offset < i;) n *= 10, n += this.buffer[this.offset] - 48, this.offset++;
			let c = n * a;
			return !t || (o = this.buffer.toString("ascii", r, i), c.toString() === o) ? c : o;
		}
		parseIntNoBigCheck(e) {
			if (e === null) return null;
			let t = 0, n = this.offset + e, r = 1;
			if (e === 0) return 0;
			for (this.buffer[this.offset] === l && (this.offset++, r = -1), this.buffer[this.offset] === u && this.offset++; this.offset < n;) t *= 10, t += this.buffer[this.offset] - 48, this.offset++;
			return t * r;
		}
		parseGeometryValue() {
			...
			function n() {
				let r, i, a, o, s, c, l = null, u = e.readUInt8(t);
				t += 1;
				let d = u ? e.readUInt32LE(t) : e.readUInt32BE(t);
				switch (t += 4, d) {
					case 1:
						r = u ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, i = u ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, l = {
							x: r,
							y: i
						};
						break;
					case 2:
						for (s = u ? e.readUInt32LE(t) : e.readUInt32BE(t), t += 4, l = [], a = s; a > 0; a--) r = u ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, i = u ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, l.push({
							x: r,
							y: i
						});
						break;
					case 3:
						let d = u ? e.readUInt32LE(t) : e.readUInt32BE(t);
						for (t += 4, l = [], a = d; a > 0; a--) {
							for (s = u ? e.readUInt32LE(t) : e.readUInt32BE(t), t += 4, c = [], o = s; o > 0; o--) r = u ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, i = u ? e.readDoubleLE(t) : e.readDoubleBE(t), t += 8, c.push({
								x: r,
								y: i
							});
							l.push(c);
					...
					case 6:
					case 7:
						let f = u ? e.readUInt32LE(t) : e.readUInt32BE(t);
						for (t += 4, l = [], a = f; a > 0; a--) l.push(n());
						break;
				}
				return l;
			}
		...
		parseDate(e) {
			...
			return !e || e === "local" ? new Date(n, r - 1, i) : e === "Z" ? new Date(Date.UTC(n, r - 1, i)) : /* @__PURE__ */ new Date(`${c(4, n)}-${c(2, r)}-${c(2, i)}T00:00:00${e}`);
		}
		parseDateTime(e) {
		...
		parseFloat(e) {
			...
			if (e === 0) return 0;
			for (this.buffer[this.offset] === l && (this.offset++, r = -1), this.buffer[this.offset] === u && this.offset++; this.offset < n;) if (a = this.buffer[this.offset], a === d) i = !0, this.offset++;
			else if (a === f || a === p) {
				this.offset++;
				let e = this.parseInt(n - this.offset);
				return t / r * 10 ** e;
		...
		writeLengthCodedNumber(e) {
			return e < 251 ? this.writeInt8(e) : e < 65535 ? (this.writeInt8(252), this.writeInt16(e)) : e < 16777215 ? (this.writeInt8(253), this.writeInt24(e)) : e === null ? this.writeInt8(251) : (this.writeInt8(254), this.buffer.writeUInt32LE(e, this.offset), this.offset += 4, this.buffer.writeUInt32LE(e >> 32, this.offset), this.offset += 4, this.offset);
		}
		writeDate(e, t) {
		...
		static lengthCodedStringLength(t, n) {
			let r = a.encode(t, n).length;
			return e.lengthCodedNumberLength(r) + r;
		}
		static MockBuffer() {
			let e = function() {}, t = Buffer.alloc(0);
			for (let n in r.prototype) typeof t[n] == "function" && (t[n] = e);
			return t;
		}
	};
})), require_packet_parser = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = 16777215;
	function i(e, t) {
...
})), require_auth_next_factor = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet();
	t.exports = class e {
		constructor(e) {
...
})), require_auth_switch_request = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet();
	t.exports = class e {
		constructor(e) {
			this.pluginName = e.pluginName, this.pluginData = e.pluginData;
...
})), require_auth_switch_request_more_data = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet();
	t.exports = class e {
		constructor(e) {
			this.data = e;
...
})), require_auth_switch_response = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet();
	t.exports = class e {
		constructor(e) {
...
})), require_types = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
		0: "DECIMAL",
		1: "TINY",
		2: "SHORT",
...
})), require_binary_row = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_types(), r = require_packet(), i = Array(256), a = class e {
		constructor(e) {
			this.columns = e || [];
		}
		static toPacket(e, t) {
...
})), require_commands$1 = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
		SLEEP: 0,
		QUIT: 1,
		INIT_DB: 2,
...
})), require_binlog_dump$1 = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = require_commands$1();
	t.exports = class {
		constructor(e) {
	...
	e.LONG_PASSWORD = 1, e.FOUND_ROWS = 2, e.LONG_FLAG = 4, e.CONNECT_WITH_DB = 8, e.NO_SCHEMA = 16, e.COMPRESS = 32, e.ODBC = 64, e.LOCAL_FILES = 128, e.IGNORE_SPACE = 256, e.PROTOCOL_41 = 512, e.INTERACTIVE = 1024, e.SSL = 2048, e.IGNORE_SIGPIPE = 4096, e.TRANSACTIONS = 8192, e.RESERVED = 16384, e.SECURE_CONNECTION = 32768, e.MULTI_STATEMENTS = 65536, e.MULTI_RESULTS = 131072, e.PS_MULTI_RESULTS = 262144, e.PLUGIN_AUTH = 524288, e.CONNECT_ATTRS = 1048576, e.PLUGIN_AUTH_LENENC_CLIENT_DATA = 2097152, e.CAN_HANDLE_EXPIRED_PASSWORDS = 4194304, e.SESSION_TRACK = 8388608, e.DEPRECATE_EOF = 16777216, e.SSL_VERIFY_SERVER_CERT = 1073741824, e.REMEMBER_OPTIONS = 2147483648, e.MULTI_FACTOR_AUTHENTICATION = 268435456;
})), require_auth_41 = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = __require("crypto");
	function n(e, n, r) {
		let i = t.createHash("sha1");
		return i.update(e), n && i.update(n), r && i.update(r), i.digest();
	}
	function r(e, t) {
	...
	function i(t, r, i) {
		...
		let a = n(t);
		return e.calculateTokenFromPasswordSha(a, r, i);
	}
	e.calculateTokenFromPasswordSha = function(e, t, i) {
		return r(n(t.slice(0, 8), i.slice(0, 12), n(e)), e);
	}, e.calculateToken = i, e.verifyToken = function(e, t, i, a) {
		return n(r(i, n(e, t, a))).compare(a) === 0;
	...
	e.xorRotating = a;
})), require_charset_encodings = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = /* @__PURE__ */ "utf8.big5.latin2.dec8.cp850.latin1.hp8.koi8r.latin1.latin2.swe7.ascii.eucjp.sjis.cp1251.latin1.hebrew.utf8.tis620.euckr.latin7.latin2.koi8u.cp1251.gb2312.greek.cp1250.latin2.gbk.cp1257.latin5.latin1.armscii8.cesu8.cp1250.ucs2.cp866.keybcs2.macintosh.macroman.cp852.latin7.latin7.macintosh.cp1250.utf8.utf8.latin1.latin1.latin1.cp1251.cp1251.cp1251.macroman.utf16.utf16.utf16-le.cp1256.cp1257.cp1257.utf32.utf32.utf16-le.binary.armscii8.ascii.cp1250.cp1256.cp866.dec8.greek.hebrew.hp8.keybcs2.koi8r.koi8u.cesu8.latin2.latin5.latin7.cp850.cp852.swe7.cesu8.big5.euckr.gb2312.gbk.sjis.tis620.ucs2.eucjp.geostd8.geostd8.latin1.cp932.cp932.eucjpms.eucjpms.cp1250.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf16.utf8.utf8.utf8.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.ucs2.utf8.utf8.utf8.utf8.utf8.utf8.utf8.ucs2.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf32.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.cesu8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.cesu8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.gb18030.gb18030.gb18030.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8.utf8".split(".");
})), require_change_user$1 = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_commands$1(), r = require_client(), i = require_packet(), a = require_auth_41(), o = require_charset_encodings();
	t.exports = class {
		constructor(e) {
...
})), require_close_statement$1 = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = require_commands$1();
	t.exports = class {
		constructor(e) {
			this.id = e;
...
})), require_field_flags = /* @__PURE__ */ __commonJSMin(((e) => {
...
})), require_column_definition = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = require_string(), i = require_charset_encodings(), a = [
		"catalog",
		"schema",
		"table",
		"orgTable",
		...
		constructor(e, t) {
			...
			let n = e.readLengthCodedNumber(), a = e.offset;
			e.offset += n, this._orgNameLength = e.readLengthCodedNumber(), this._orgNameStart = e.offset, e.offset += this._orgNameLength, e.skip(1), this.characterSet = e.readInt16(), this.encoding = i[this.characterSet], this.name = r.decode(this._buf, this.encoding === "binary" ? this._clientEncoding : this.encoding, a, a + n), this.columnLength = e.readInt32(), this.columnType = e.readInt8(), this.type = this.columnType, this.flags = e.readInt16(), this.decimals = e.readInt8();
		}
		inspect() {
			return {
		...
		[Symbol.for("nodejs.util.inspect.custom")](e, t, n) {
			let r = require_types(), i = [];
			for (let e in r) i[r[e]] = e;
			let a = require_field_flags(), o = [], s = this.flags;
	...
	s("catalog"), s("schema"), s("table"), s("orgTable"), s("orgName"), t.exports = o;
})), require_cursor = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
		NO_CURSOR: 0,
		READ_ONLY: 1,
		FOR_UPDATE: 2,
...
})), require_execute$1 = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_cursor(), r = require_commands$1(), i = require_types(), a = require_packet(), o = require_charset_encodings();
	function s(e) {
		return Array.isArray(e) || e.constructor === Object || typeof e.toJSON == "function" && !Buffer.isBuffer(e);
	}
	function c(e, t, n) {
		let r = i.VAR_STRING, o, c = function(e) {
			return a.prototype.writeLengthCodedString.call(this, e, t);
		};
		if (e !== null) switch (typeof e) {
			case "undefined": throw TypeError("Bind parameters must not contain undefined");
			case "number":
				r = i.DOUBLE, o = 8, c = a.prototype.writeDouble;
				break;
			case "boolean":
				e |= 0, r = i.TINY, o = 1, c = a.prototype.writeInt8;
				break;
			case "object":
				Object.prototype.toString.call(e) === "[object Date]" ? (r = i.DATETIME, o = 12, c = function(e) {
					return a.prototype.writeDate.call(this, e, n);
				}) : s(e) ? (e = JSON.stringify(e), r = i.JSON) : Buffer.isBuffer(e) && (o = a.lengthCodedNumberLength(e.length) + e.length, c = a.prototype.writeLengthCodedBuffer);
				break;
			default: e = e.toString();
		}
		else e = "", r = i.NULL;
		return o ||= a.lengthCodedStringLength(e, t), {
			value: e,
			type: r,
			length: o,
			writer: c
	...
	t.exports = class {
		constructor(e, t, n, r) {
			this.id = e, this.parameters = t, this.encoding = o[n], this.timezone = r;
		}
		static fromPacket(e, t) {
			let n = e.readInt32(), r = e.readInt8(), a = e.readInt32(), o = e.offset;
			for (; o < e.end - 1 && !((e.buffer[o + 1] === i.VAR_STRING || e.buffer[o + 1] === i.NULL || e.buffer[o + 1] === i.DOUBLE || e.buffer[o + 1] === i.TINY || e.buffer[o + 1] === i.DATETIME || e.buffer[o + 1] === i.JSON) && e.buffer[o] === 1 && e.buffer[o + 2] === 0);) e.readInt8(), o++;
			let s = [];
			for (let t = e.offset + 1; t < e.end - 1; t++) (e.buffer[t] === i.VAR_STRING || e.buffer[t] === i.NULL || e.buffer[t] === i.DOUBLE || e.buffer[t] === i.TINY || e.buffer[t] === i.DATETIME || e.buffer[t] === i.JSON) && e.buffer[t + 1] === 0 && (s.push(e.buffer[t]), e.skip(2));
			e.skip(1);
			let c = [];
			for (let n = 0; n < s.length; n++) s[n] === i.VAR_STRING ? c.push(e.readLengthCodedString(t)) : s[n] === i.DOUBLE ? c.push(e.readDouble()) : s[n] === i.TINY ? c.push(e.readInt8()) : s[n] === i.DATETIME ? c.push(e.readDateTime()) : s[n] === i.JSON && c.push(JSON.parse(e.readLengthCodedString(t))), s[n] === i.NULL && c.push(null);
			return {
				stmtId: n,
				flags: r,
				iterationCount: a,
		...
		toPacket() {
			let e = 14, t;
			this.parameters && this.parameters.length > 0 && (e += Math.floor((this.parameters.length + 7) / 8), e += 1, e += 2 * this.parameters.length, t = this.parameters.map((e) => c(e, this.encoding, this.timezone)), e += t.reduce((e, t) => e + t.length, 0));
			let o = new a(0, Buffer.allocUnsafe(e), 0, e);
			if (o.offset = 4, o.writeInt8(r.STMT_EXECUTE), o.writeInt32(this.id), o.writeInt8(n.NO_CURSOR), o.writeInt32(1), t) {
				let e = 0, n = 1;
				t.forEach((t) => {
					t.type === i.NULL && (e += n), n *= 2, n === 256 && (o.writeInt8(e), e = 0, n = 1);
				}), n !== 1 && o.writeInt8(e), o.writeInt8(1), t.forEach((e) => {
					o.writeInt8(e.type), o.writeInt8(0);
				}), t.forEach((e) => {
					e.type !== i.NULL && e.writer.call(o, e.value);
				});
			}
			return o;
		}
	};
})), require_handshake = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = require_client();
	t.exports = class e {
		constructor(e) {
			this.protocolVersion = e.protocolVersion, this.serverVersion = e.serverVersion, this.capabilityFlags = e.capabilityFlags, this.connectionId = e.connectionId, this.authPluginData1 = e.authPluginData1, this.authPluginData2 = e.authPluginData2, this.characterSet = e.characterSet, this.statusFlags = e.statusFlags, this.autPluginName = e.autPluginName;
		}
		setScrambleData(e) {
			__require("crypto").randomBytes(20, (t, n) => {
				if (t) {
					e(t);
					return;
				}
		...
		toPacket(e) {
			let t = 68 + Buffer.byteLength(this.serverVersion, "utf8"), r = new n(e, Buffer.alloc(t + 4, 0), 0, t + 4);
		...
		static fromPacket(t) {
			...
			return n.capabilityFlags & r.PLUGIN_AUTH && (n.autPluginName = t.readNullTerminatedString("ascii")), new e(n);
		}
	};
})), require_handshake_response = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_client(), r = require_charset_encodings(), i = require_packet(), a = require_auth_41();
	t.exports = class {
		constructor(e) {
			this.user = e.user || "", this.database = e.database || "", this.password = e.password || "", this.passwordSha1 = e.passwordSha1, this.authPluginData1 = e.authPluginData1, this.authPluginData2 = e.authPluginData2, this.compress = e.compress, this.clientFlags = e.flags;
			let t;
			t = this.passwordSha1 ? a.calculateTokenFromPasswordSha(this.passwordSha1, this.authPluginData1, this.authPluginData2) : a.calculateToken(this.password, this.authPluginData1, this.authPluginData2), this.authToken = t, this.charsetNumber = e.charsetNumber, this.encoding = r[e.charsetNumber], this.connectAttributes = e.connectAttributes;
		}
		serializeResponse(e) {
			let t = (e) => this.clientFlags & n[e], r = new i(0, e, 0, e.length);
			r.offset = 4, r.writeInt32(this.clientFlags), r.writeInt32(0), r.writeInt8(this.charsetNumber), r.skip(23);
			let a = this.encoding;
			r.writeNullTerminatedString(this.user, a);
			let o;
			if (t("PLUGIN_AUTH_LENENC_CLIENT_DATA") ? (r.writeLengthCodedNumber(this.authToken.length), r.writeBuffer(this.authToken)) : t("SECURE_CONNECTION") ? (r.writeInt8(this.authToken.length), r.writeBuffer(this.authToken)) : (r.writeBuffer(this.authToken), r.writeInt8(0)), t("CONNECT_WITH_DB") && r.writeNullTerminatedString(this.database, a), t("PLUGIN_AUTH") && r.writeNullTerminatedString("mysql_native_password", "latin1"), t("CONNECT_ATTRS")) {
				let e = this.connectAttributes || {}, t = Object.keys(e), n = 0;
		...
		static fromPacket(e) {
			let t = {};
			t.clientFlags = e.readInt32();
			function i(e) {
				return t.clientFlags & n[e];
			}
			t.maxPacketSize = e.readInt32(), t.charsetNumber = e.readInt8();
			let a = r[t.charsetNumber];
			t.encoding = a, e.skip(23), t.user = e.readNullTerminatedString(a);
			let o;
			if (i("PLUGIN_AUTH_LENENC_CLIENT_DATA") ? (o = e.readLengthCodedNumber(a), t.authToken = e.readBuffer(o)) : i("SECURE_CONNECTION") ? (o = e.readInt8(), t.authToken = e.readBuffer(o)) : t.authToken = e.readNullTerminatedString(a), i("CONNECT_WITH_DB") && (t.database = e.readNullTerminatedString(a)), i("PLUGIN_AUTH") && (t.authPluginName = e.readNullTerminatedString(a)), i("CONNECT_ATTRS")) {
				let n = e.readLengthCodedNumber(a), r = e.offset + n, i = {};
				for (; e.offset < r;) i[e.readLengthCodedString(a)] = e.readLengthCodedString(a);
				t.connectAttributes = i;
			}
			return t;
		}
	};
})), require_prepare_statement = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = require_commands$1(), i = require_string(), a = require_charset_encodings();
	t.exports = class {
		constructor(e, t) {
...
})), require_prepared_statement_header = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = class {
		constructor(e) {
...
})), require_query$1 = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = require_commands$1(), i = require_string(), a = require_charset_encodings();
	t.exports = class {
		constructor(e, t) {
			this.query = e, this.charsetNumber = t, this.encoding = a[t];
...
})), require_register_slave$1 = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = require_commands$1();
	t.exports = class {
		constructor(e) {
...
})), require_server_status = /* @__PURE__ */ __commonJSMin(((e) => {
...
})), require_encoding_charset = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
		big5: 1,
		latin2: 2,
		dec8: 3,
...
})), require_session_track = /* @__PURE__ */ __commonJSMin(((e) => {
...
})), require_resultset_header = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet(), r = require_client(), i = require_server_status(), a = require_encoding_charset(), o = require_session_track();
	t.exports = class {
		constructor(e, t) {
...
})), require_ssl_request = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_client(), r = require_packet();
	t.exports = class {
		constructor(e, t) {
			this.clientFlags = e | n.SSL, this.charset = t;
		}
		toPacket() {
			let e = Buffer.allocUnsafe(36), t = new r(0, e, 0, 36);
			return e.fill(0), t.offset = 4, t.writeInt32(this.clientFlags), t.writeInt32(0), t.writeInt8(this.charset), t;
		}
	};
})), require_text_row = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packet();
	t.exports = class e {
		constructor(e) {
			this.columns = e || [];
...
})), require_packets = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_browser(), r = {
	...
	Object.entries(r).forEach(([e, r]) => {
		if (t.exports[e] = r, n.env.NODE_DEBUG && r.prototype.toPacket) {
			let t = r.prototype.toPacket;
			r.prototype.toPacket = function() {
				let n = t.call(this);
				return n._name = e, n;
			};
		}
	});
	var i = require_packet();
	e.Packet = i, e.OK = class {
		static toPacket(e, t) {
			e ||= {};
			let n = e.affectedRows || 0, r = e.insertId || 0, a = e.serverStatus || 0, o = e.warningCount || 0, s = e.message || "", c = 9 + i.lengthCodedNumberLength(n);
			c += i.lengthCodedNumberLength(r);
			let l = new i(0, Buffer.allocUnsafe(c), 0, c);
			return l.offset = 4, l.writeInt8(0), l.writeLengthCodedNumber(n), l.writeLengthCodedNumber(r), l.writeInt16(a), l.writeInt16(o), l.writeString(s, t), l._name = "OK", l;
		}
	}, e.EOF = class {
		static toPacket(e, t) {
			e === void 0 && (e = 0), t === void 0 && (t = 0);
			let n = new i(0, Buffer.allocUnsafe(9), 0, 9);
			return n.offset = 4, n.writeInt8(254), n.writeInt16(e), n.writeInt16(t), n._name = "EOF", n;
		}
	}, e.Error = class e {
		static toPacket(e, t) {
			let n = 13 + Buffer.byteLength(e.message, "utf8"), r = new i(0, Buffer.allocUnsafe(n), 0, n);
...
})), require_command = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_events().EventEmitter, r = __require("timers");
	t.exports = class extends n {
		...
		execute(e, t) {
			if (this.next || (this.next = this.start, t._resetSequenceId()), e && e.isError()) {
				...
				return n.sql = this.sql || this.query, this.queryTimeout &&= (r.clearTimeout(this.queryTimeout), null), this.onResult ? (this.onResult(n), this.emit("end")) : (this.emit("error", n), this.emit("end")), !0;
			}
			return this.next = this.next(e, t), this.next ? !1 : (this.emit("end"), !0);
		}
	};
})), require_sha256_password = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = "sha256_password", r = __require("crypto"), { xorRotating: i } = require_auth_41(), a = Buffer.from([1]), o = 0, s = 1, c = -1;
	function l(e, t, n) {
		let a = i(Buffer.from(`${e}\0`, "utf8"), t);
		return r.publicEncrypt(n, a);
	}
	t.exports = (e = {}) => ({ connection: t }) => {
		let r = 0, i = null, u = t.config.password, d = (e) => {
			let t = l(u, i, e);
			return r = c, t;
		};
		return (t) => {
			switch (r) {
				case o: return i = t.slice(0, 20), e.serverPublicKey ? d(e.serverPublicKey) : (r = s, a);
				case s: return e.onServerPublicKey && e.onServerPublicKey(t), d(t);
				case c: throw Error(`Unexpected data in AuthMoreData packet received by ${n} plugin in STATE_FINAL state.`);
			}
			throw Error(`Unexpected data in AuthMoreData packet received by ${n} plugin in state ${r}`);
		};
	};
})), require_caching_sha2_password = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = "caching_sha2_password", r = __require("crypto"), { xor: i, xorRotating: a } = require_auth_41(), o = Buffer.from([2]), s = Buffer.from([3]), c = Buffer.from([4]), l = 0, u = 1, d = 2, f = -1;
	function p(e) {
		let t = r.createHash("sha256");
		return t.update(e), t.digest();
	}
	function m(e, t) {
		if (!e) return Buffer.alloc(0);
		let n = p(Buffer.from(e)), r = p(n);
		return i(n, p(Buffer.concat([r, t])));
	}
	function h(e, t, n) {
		let i = a(Buffer.from(`${e}\0`, "utf8"), t);
		return r.publicEncrypt({
			key: n,
			padding: r.constants.RSA_PKCS1_OAEP_PADDING
		}, i);
	}
	t.exports = (e = {}) => ({ connection: t }) => {
		let r = 0, i = null, a = t.config.password, p = (e) => {
			let t = h(a, i, e);
			return r = f, t;
		};
		return (h) => {
			switch (r) {
				case l: return i = h.slice(0, 20), r = u, m(a, i);
				case u:
					if (s.equals(h)) return r = f, null;
					if (c.equals(h)) return (e.overrideIsSecure === void 0 ? t.config.ssl || t.config.socketPath : e.overrideIsSecure) ? (r = f, Buffer.from(`${a}\0`, "utf8")) : e.serverPublicKey ? p(e.serverPublicKey) : (r = d, o);
					throw Error(`Invalid AuthMoreData packet received by ${n} plugin in STATE_TOKEN_SENT state.`);
				case d: return e.onServerPublicKey && e.onServerPublicKey(h), p(h);
				case f: throw Error(`Unexpected data in AuthMoreData packet received by ${n} plugin in STATE_FINAL state.`);
			}
			throw Error(`Unexpected data in AuthMoreData packet received by ${n} plugin in state ${r}`);
		};
	};
})), require_mysql_native_password = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_auth_41();
...
})), require_mysql_clear_password = /* @__PURE__ */ __commonJSMin(((e, t) => {
	function n(e) {
...
})), require_auth_switch = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_packets(), r = require_sha256_password(), i = require_caching_sha2_password(), a = require_mysql_native_password(), o = require_mysql_clear_password(), s = {
		sha256_password: r({}),
	...
	function u(e, t, r) {
		let { pluginName: i, pluginData: a } = n.AuthSwitchRequest.fromPacket(e), o = t.config.authPlugins && t.config.authPlugins[i];
		...
		if (o ||= s[i], !o) throw Error(`Server requests authentication using unknown plugin ${i}. See TODO: add plugins doco here on how to configure or author authentication plugins.`);
		t._authPlugin = o({
			connection: t,
			command: r
	...
	t.exports = {
		authSwitchRequest: u,
		authSwitchRequestMoreData: d
	};
})), require_seq_queue$1 = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_events().EventEmitter, r = __require("util"), i = 3e3, a = 0, o = "closed", s = "drained", c = function(e) {
		n.call(this), e && e > 0 ? this.timeout = e : this.timeout = i, this.status = l.STATUS_IDLE, this.curId = a, this.queue = [];
	};
	r.inherits(c, n), c.prototype.push = function(e, t, n) {
		if (this.status !== l.STATUS_IDLE && this.status !== l.STATUS_BUSY) return !1;
		if (typeof e != "function") throw Error("fn should be a function.");
		if (this.queue.push({
			fn: e,
			ontimeout: t,
			timeout: n
		}), this.status === l.STATUS_IDLE) {
			this.status = l.STATUS_BUSY;
			var r = this;
		...
		this.status !== l.STATUS_IDLE && this.status !== l.STATUS_BUSY || (e ? (this.status = l.STATUS_DRAINED, this.timerId &&= (clearTimeout(this.timerId), void 0), this.emit(s)) : (this.status = l.STATUS_CLOSED, this.emit(o)));
	}, c.prototype._next = function(e) {
		if (!(e !== this.curId || this.status !== l.STATUS_BUSY && this.status !== l.STATUS_CLOSED)) {
			this.timerId &&= (clearTimeout(this.timerId), void 0);
			var t = this.queue.shift();
			if (!t) {
				this.status === l.STATUS_BUSY ? (this.status = l.STATUS_IDLE, this.curId++) : (this.status = l.STATUS_DRAINED, this.emit(s));
				return;
			}
			var n = this;
			t.id = ++this.curId;
			var r = t.timeout > 0 ? t.timeout : this.timeout;
			r = r > 0 ? r : i, this.timerId = setTimeout(function() {
				process.nextTick(function() {
					n._next(t.id);
				}), n.emit("timeout", t), t.ontimeout && t.ontimeout();
			}, r);
			try {
				t.fn({ done: function() {
					var e = t.id === n.curId;
				...
				n.emit("error", e, t), process.nextTick(function() {
					n._next(t.id);
				});
			}
		}
	...
	var l = t.exports;
	l.STATUS_IDLE = 0, l.STATUS_BUSY = 1, l.STATUS_CLOSED = 2, l.STATUS_DRAINED = 3, l.createQueue = function(e) {
		return new c(e);
	};
})), require_seq_queue = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = require_seq_queue$1();
})), require_compressed_protocol = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = __require("zlib"), r = require_packet_parser();
	function i(e) {
		let t = this, r = e.readInt24(), i = e.readBuffer();
		r === 0 ? t.inflateQueue.push((n) => {
			t._bumpCompressedSequenceId(e.numPackets), t._inflatedPacketsParser.execute(i), n.done();
		}) : t.inflateQueue.push((r) => {
			n.inflate(i, (n, i) => {
				if (n) {
					t._handleNetworkError(n);
					return;
				}
				t._bumpCompressedSequenceId(e.numPackets), t._inflatedPacketsParser.execute(i), r.done();
			});
		});
	}
	function a(e) {
		let t = 16777210, r;
		if (e.length > t) {
			for (r = 0; r < e.length; r += t) a.call(this, e.slice(r, r + t));
			return;
		}
		let i = this, o = e.length, s = Buffer.allocUnsafe(7);
		(function(t) {
			i.deflateQueue.push((r) => {
				n.deflate(e, (n, a) => {
					if (n) {
						i._handleFatalError(n);
						return;
					}
					let c = a.length;
					c < o ? (s.writeUInt8(c & 255, 0), s.writeUInt16LE(c >> 8, 1), s.writeUInt8(t, 3), s.writeUInt8(o & 255, 4), s.writeUInt16LE(o >> 8, 5), i.writeUncompressed(s), i.writeUncompressed(a)) : (c = o, o = 0, s.writeUInt8(c & 255, 0), s.writeUInt16LE(c >> 8, 1), s.writeUInt8(t, 3), s.writeUInt8(o & 255, 4), s.writeUInt16LE(o >> 8, 5), i.writeUncompressed(s), i.writeUncompressed(e)), r.done();
				});
			});
		})(i.compressedSequenceId), i._bumpCompressedSequenceId(1);
	}
	function o(e) {
		e._lastWrittenPacketId = 0, e._lastReceivedPacketId = 0, e._handleCompressedPacket = i, e._inflatedPacketsParser = new r((t) => {
			e.handlePacket(t);
		}, 4), e._inflatedPacketsParser._lastPacket = 0, e.packetParser = new r((t) => {
			e._handleCompressedPacket(t);
		}, 7), e.writeUncompressed = e.write, e.write = a;
		let t = require_seq_queue();
		e.inflateQueue = t.createQueue(), e.deflateQueue = t.createQueue();
	}
	t.exports = { enableCompression: o };
})), require_client_handshake = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_command(), r = require_packets(), i = require_client(), a = require_charset_encodings(), o = require_auth_41();
	function s(e) {
		let t = [];
	...
	t.exports = class e extends n {
		constructor(e) {
			super(), this.handshake = null, this.clientFlags = e, this.authenticationFactor = 0;
		}
		start() {
			return e.prototype.handshakeInit;
		}
		sendSSLRequest(e) {
			let t = new r.SSLRequest(this.clientFlags, e.config.charsetNumber);
			e.writePacket(t.toPacket());
		}
		sendCredentials(e) {
			e.config.debug && console.log("Sending handshake packet: flags:%d=(%s)", this.clientFlags, s(this.clientFlags).join(", ")), this.user = e.config.user, this.password = e.config.password, this.password1 = e.config.password, this.password2 = e.config.password2, this.password3 = e.config.password3, this.passwordSha1 = e.config.passwordSha1, this.database = e.config.database, this.autPluginName = this.handshake.autPluginName;
			let t = new r.HandshakeResponse({
		...
		calculateNativePasswordAuthToken(e) {
			...
			return r = this.passwordSha1 ? o.calculateTokenFromPasswordSha(this.passwordSha1, t, n) : o.calculateToken(this.password, t, n), r;
		}
		handshakeInit(t, n) {
			this.on("error", (e) => {
				n._fatalError = e, n._protocolError = e;
			}), this.handshake = r.Handshake.fromPacket(t), n.config.debug && console.log("Server hello packet: capability flags:%d=(%s)", this.handshake.capabilityFlags, s(this.handshake.capabilityFlags).join(", ")), n.serverCapabilityFlags = this.handshake.capabilityFlags, n.serverEncoding = a[this.handshake.characterSet], n.connectionId = this.handshake.connectionId;
			let o = this.handshake.capabilityFlags & i.SSL, c = this.handshake.capabilityFlags & i.MULTI_FACTOR_AUTHENTICATION;
		...
		handshakeResult(t, n) {
			...
			if (!n.authorized && (n.authorized = !0, n.config.compress)) {
				let e = require_compressed_protocol().enableCompression;
				e(n);
			}
			return this.onResult && this.onResult(null), null;
		}
	};
})), require_server_handshake = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_commands$1(), r = require_errors(), i = require_command(), a = require_packets();
	t.exports = class e extends i {
		...
		readClientReply(t, n) {
			let r = a.HandshakeResponse.fromPacket(t);
...
})), require_charsets = /* @__PURE__ */ __commonJSMin(((e) => {
	...
	var n, r = !1;
	try {
		n = __require("cardinal").highlight;
	} catch {
		n = (e) => (r ||= (console.log("For nicer debug output consider install cardinal@^2.0.0"), !0), e);
	}
	function i(e, t) {
		console.log(`\n\n${e}:\n`), console.log(`${n(t)}\n`);
	}
	e.printDebugWithCode = i;
	function a(e, t, n) {
	...
	e.privateObjectProps = o, e.fieldEscape = (e) => {
		if (o.has(e)) throw Error(`The field name (${e}) can't be the same as an object's private property.`);
		return t(e);
	};
})), require_is_property = /* @__PURE__ */ __commonJSMin(((e, t) => {
	function n(e) {
	...
	t.exports = n;
})), require_generate_function = /* @__PURE__ */ __commonJSMin(((e, t) => {
	for (var n = __require("util"), r = require_is_property(), i = /[\{\[]/, a = /[\}\]]/, o = /* @__PURE__ */ "do.if.in.for.let.new.try.var.case.else.enum.eval.null.this.true.void.with.await.break.catch.class.const.false.super.throw.while.yield.delete.export.import.public.return.static.switch.typeof.default.extends.finally.package.private.continue.debugger.function.arguments.interface.protected.implements.instanceof.NaN.undefined".split("."), s = {}, c = 0; c < o.length; c++) s[o[c]] = !0;
	var l = function(e) {
		...
		var e = [], t = 0, o = {}, s = function(n) {
			for (var r = ""; r.length < t * 2;) r += "  ";
			e.push(r + n);
		}, c = function(e) {
			if (a.test(e.trim()[0]) && i.test(e[e.length - 1])) {
				t--, s(e), t++;
				return;
			}
			if (i.test(e[e.length - 1])) {
				s(e), t++;
				return;
			}
			if (a.test(e.trim()[0])) {
			...
			if (!e) return d;
			if (arguments.length === 1 && e.indexOf("\n") > -1) for (var t = e.trim().split("\n"), r = 0; r < t.length; r++) c(t[r].trim());
			else c(n.format.apply(n, arguments));
			return d;
		};
		return d.scope = {}, d.formats = u, d.sym = function(e) {
			return (!e || !l(e)) && (e = "tmp"), o[e] || (o[e] = 0), e + (o[e]++ || "");
		}, d.property = function(e, t) {
			return arguments.length === 1 && (t = e, e = ""), t += "", r(t) ? e ? e + "." + t : t : e ? e + "[" + JSON.stringify(t) + "]" : JSON.stringify(t);
		}, d.toString = function() {
			return e.join("\n");
		}, d.toFunction = function(e) {
			e ||= {};
			var t = "return (" + d.toString() + ")";
			Object.keys(d.scope).forEach(function(t) {
				e[t] || (e[t] = d.scope[t]);
			});
		...
		}, arguments.length && d.apply(null, arguments), d;
	};
	d.formats = u, t.exports = d;
})), require_parser_cache = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_index_cjs().default, r = new n({ max: 15e3 });
	function i(e, t, n, r) {
		let i = [
			e,
			typeof n.nestTables,
...
})), require_text_parser = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_types(), r = require_charsets(), i = require_helpers(), a = require_generate_function(), o = require_parser_cache(), s = [];
	for (let e in n) s[n[e]] = e;
	function c(e, t, a, o, s) {
		let c = !!(s.supportBigNumbers || o.supportBigNumbers), l = !!(s.bigNumberStrings || o.bigNumberStrings), u = s.timezone || o.timezone, d = s.dateStrings || o.dateStrings;
		switch (e) {
			case n.TINY:
			case n.SHORT:
			case n.LONG:
			...
			case n.LONGLONG: return c && l ? "packet.parseLengthCodedIntString()" : `packet.parseLengthCodedInt(${c})`;
			case n.FLOAT:
			case n.DOUBLE: return "packet.parseLengthCodedFloat()";
			case n.NULL: return "packet.readLengthCodedNumber()";
			case n.DECIMAL:
			case n.NEWDECIMAL: return o.decimalNumbers ? "packet.parseLengthCodedFloat()" : "packet.readLengthCodedString(\"ascii\")";
			case n.DATE: return i.typeMatch(e, d, n) ? "packet.readLengthCodedString(\"ascii\")" : `packet.parseDate(${i.srcEscape(u)})`;
			case n.DATETIME:
			case n.TIMESTAMP: return i.typeMatch(e, d, n) ? "packet.readLengthCodedString(\"ascii\")" : `packet.parseDateTime(${i.srcEscape(u)})`;
			...
			case n.JSON: return o.jsonStrings ? "packet.readLengthCodedString(\"utf8\")" : "JSON.parse(packet.readLengthCodedString(\"utf8\"))";
			default: return t === r.BINARY ? "packet.readLengthCodedBuffer()" : `packet.readLengthCodedString(${a})`;
		}
	}
	function l(e, t, r) {
		...
		let l = a();
		l("(function () {")("return class TextRow {"), l("constructor(fields) {"), typeof t.typeCast == "function" && (l("const _this = this;"), l("for(let i=0; i<fields.length; ++i) {"), l("this[`wrap${i}`] = wrap(fields[i], _this);"), l("}")), l("}"), l("next(packet, fields, options) {"), l("this.packet = packet;"), t.rowsAsArray ? l(`const result = new Array(${e.length});`) : l("const result = {};");
		let u = {}, d = [];
		if (t.nestTables === !0) {
			for (let t = 0; t < e.length; t++) u[e[t].table] = 1;
			d = Object.keys(u);
			for (let e = 0; e < d.length; e++) l(`result[${i.fieldEscape(d[e])}] = {};`);
		}
		let f = "", p = "", m = "";
		for (let n = 0; n < e.length; n++) if (p = i.fieldEscape(e[n].name), typeof t.nestTables == "string" ? f = `result[${i.fieldEscape(e[n].table + t.nestTables + e[n].name)}]` : t.nestTables === !0 ? (m = i.fieldEscape(e[n].table), l(`if (!result[${m}]) result[${m}] = {};`), f = `result[${m}][${p}]`) : f = t.rowsAsArray ? `result[${n.toString(10)}]` : `result[${p}]`, t.typeCast === !1) l(`${f} = packet.readLengthCodedBuffer();`);
		else {
			let i = `fields[${n}].encoding`, a = c(e[n].columnType, e[n].characterSet, i, r, t);
			typeof t.typeCast == "function" ? l(`${f} = options.typeCast(this.wrap${n}, function() { return ${a} });`) : l(`${f} = ${a};`);
		}
		return l("return result;"), l("}"), l("};")("})()"), r.debug && i.printDebugWithCode("Compiled text protocol row parser", l.toString()), typeof t.typeCast == "function" ? l.toFunction({ wrap: o }) : l.toFunction();
	}
	function u(e, t, n) {
		return o.getParser("text", e, t, n, l);
	}
	t.exports = u;
})), require_query = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_browser(), r = __require("timers"), i = __require("stream").Readable, a = require_command(), o = require_packets(), s = require_text_parser(), c = require_server_status(), l = new o.Packet(0, Buffer.allocUnsafe(4), 0, 4), u = class e extends a {
		constructor(e, t) {
		...
		start(t, n) {
			...
			let r = new o.Query(this.sql, n.config.charsetNumber);
			return n.writePacket(r.toPacket(1)), e.prototype.resultsetHeader;
		}
		done() {
			if (this._unpipeStream(), this.timeout && !this.queryTimeout) return null;
			if (this.queryTimeout &&= (r.clearTimeout(this.queryTimeout), null), this.onResult) {
				let e, t;
				this._resultIndex === 0 ? (e = this._rows[0], t = this._fields[0]) : (e = this._rows, t = this._fields), t ? n.nextTick(() => {
		...
		resultsetHeader(e, t) {
			let n = new o.ResultSetHeader(e, t);
		...
		_streamLocalInfile(e, t) {
			...
			else return this._localStreamError = /* @__PURE__ */ Error(`As a result of LOCAL INFILE command server wants to read ${t} file, but as of v2.0 you must provide streamFactory option returning ReadStream.`), e.writePacket(l), this.infileOk;
			let n = () => {
				this._unpipeStream();
			}, r = () => {
				...
				t.copy(n, 4), e.writePacket(new o.Packet(0, n, 0, n.length));
			}, s = () => {
				e.removeListener("error", n), e.writePacket(l);
			}, c = (t) => {
				this._localStreamError = t, e.removeListener("error", n), e.writePacket(l);
			};
			return this._unpipeStream = () => {
				e.stream.removeListener("pause", i), e.stream.removeListener("drain", r), this._localStream.removeListener("data", a), this._localStream.removeListener("end", s), this._localStream.removeListener("error", c);
			}, e.stream.on("pause", i), e.stream.on("drain", r), this._localStream.on("data", a), this._localStream.on("end", s), this._localStream.on("error", c), e.once("error", n), this.infileOk;
		}
		readField(t, n) {
			if (this._receivedFieldsCount++, this._fields[this._resultIndex].length !== this._fieldCount) {
				let e = new o.ColumnDefinition(t, n.clientEncoding);
			...
			if (this._receivedFieldsCount === this._fieldCount) {
				...
				return this.emit("fields", t), this._rowParser = new (s(t, this.options, n.config))(t), e.prototype.fieldsEOF;
			}
		...
		row(t, n) {
			if (t.isEOF()) return t.eofStatusFlags() & c.SERVER_MORE_RESULTS_EXISTS ? (this._resultIndex++, e.prototype.resultsetHeader) : this.done();
			let r;
			try {
		...
		stream(e) {
			...
			return t._read = () => {
				...
				t.push(e) || this._connection.pause(), t.emit("result", e, n);
			}), this.on("error", (e) => {
				t.emit("error", e);
			}), this.on("end", () => {
				t.push(null);
		...
		_setTimeout() {
			if (this.timeout) {
				...
				this.queryTimeout = r.setTimeout(e, this.timeout);
			}
		}
		_handleTimeoutError() {
			this.queryTimeout &&= (r.clearTimeout(this.queryTimeout), null);
	...
	u.prototype.catch = u.prototype.then, t.exports = u;
})), require_close_statement = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_command(), r = require_packets();
	t.exports = class extends n {
		constructor(e) {
			super(), this.id = e;
		}
...
})), require_binary_parser = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_field_flags(), r = require_charsets(), i = require_types(), a = require_helpers(), o = require_generate_function(), s = require_parser_cache(), c = [];
	for (let e in i) c[i[e]] = e;
	function l(e, t, o, s) {
		...
		switch (e.columnType) {
			...
			case i.DATETIME:
			case i.TIMESTAMP:
			case i.NEWDATE: return a.typeMatch(e.columnType, d, i) ? `packet.readDateTimeString(${parseInt(e.decimals, 10)});` : `packet.readDateTime(${a.srcEscape(u)});`;
			...
			case i.JSON: return t.jsonStrings ? "packet.readLengthCodedString(\"utf8\")" : "JSON.parse(packet.readLengthCodedString(\"utf8\"));";
	...
	function u(e, t, r) {
		let s = o(), u = Math.floor((e.length + 7 + 2) / 8);
		function d(e, t) {
			return {
				type: c[e.columnType],
				length: e.columnLength,
				...
				string: function(r = e.encoding) {
					if (e.columnType === i.JSON && r === e.encoding && console.warn(`typeCast: JSON column "${e.name}" is interpreted as BINARY by default, recommended to manually set utf8 encoding: \`field.string("utf8")\``), [
						...
						i.TIMESTAMP,
						i.DATE
					].includes(e.columnType)) return t.readDateTimeString(parseInt(e.decimals, 10));
		...
		for (let e = 0; e < u; ++e) s(`const nullBitmaskByte${e} = packet.readInt8();`);
		let f = "", p = 4, m = 0, h = "", g = "";
	...
	function d(e, t, n) {
		return s.getParser("binary", e, t, n, u);
	}
	t.exports = d;
})), require_execute = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_command(), r = require_query(), i = require_packets(), a = require_binary_parser(), o = class e extends n {
		constructor(e, t) {
		...
		buildParserFromFields(e, t) {
			return a(e, this.options, t.config);
		}
		start(t, n) {
			this._connection = n, this.options = Object.assign({}, n.config, this._executeOptions), this._setTimeout();
			let r = new i.Execute(this.statement.id, this.parameters, n.config.charsetNumber, n.config.timezone);
			try {
				n.writePacket(r.toPacket(1));
			} catch (e) {
				this.onResult(e);
			}
		...
		readField(t, n) {
			let r, a = new i.ColumnDefinition(t, n.clientEncoding);
	...
	t.exports = class e extends r {
		...
		start(t, r) {
			this.key = r.constructor.statementKey(this.options);
			let i = r._statements.get(this.key);
			if (i) return this.onResult && this.onResult(null, i), null;
			let a = new n.PrepareStatement(this.query, r.config.charsetNumber, this.options.values);
			return r.writePacket(a.toPacket(1)), e.prototype.prepareHeader;
		}
		prepareHeader(t, r) {
		...
		readParameter(t, r) {
			...
			let i = new n.ColumnDefinition(t, r.clientEncoding);
...
})), require_ping = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_command(), r = require_commands$1(), i = require_packet();
	t.exports = class e extends n {
		constructor(e) {
...
})), require_register_slave = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_command(), r = require_packets();
	t.exports = class e extends n {
		constructor(e, t) {
...
})), require_binlog_query_statusvars = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = {
		FLAGS2: 0,
		SQL_MODE: 1,
		CATALOG: 2,
...
})), require_binlog_dump = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_command(), r = require_packets(), i = [], a = class {
		constructor(e) {
		...
		constructor(e) {
			let t = require_binlog_query_statusvars();
...
})), require_change_user = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_command(), r = require_packets(), i = require_client(), a = require_client_handshake(), o = require_charset_encodings(), s = class e extends n {
		constructor(e, t) {
...
})), require_quit = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_command(), r = require_commands$1(), i = require_packet();
	t.exports = class extends n {
		constructor(e) {
			super(), this.onResult = e;
...
})), require_commands = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
	...
	typings: () => typings,
	version: () => version$1
}, 1), name, version$1, description, main, typings, scripts, repository, homepage, keywords, files, exports$1, engines, author, dependencies, devDependencies, package_default, init_package = __esmMin((() => {
	name = "mysql2", version$1 = "3.11.0", description = "fast mysql driver. Implements core protocol, prepared statements, ssl and compression in native JS", main = "index.js", typings = "typings/mysql/index", scripts = {
	...
	}, homepage = "https://sidorares.github.io/node-mysql2/docs", keywords = [
		"mysql",
		"client",
		"server"
	], files = [
	...
	}, engines = { node: ">= 8.0" }, author = "Andrey Sidorov <andrey.sidorov@gmail.com>", dependencies = {
		...
		typings,
		scripts,
		"lint-staged": { "*.js": ["prettier --single-quote --trailing-comma none --write", "git add"] },
		repository,
		homepage,
		keywords,
		files,
...
})), require_proxies = /* @__PURE__ */ __commonJSMin(((e) => {
	...
	var n = require_defaults(), r = require_proxies(), i = { ca: r.proxies }, a = { ca: [...n.defaults, ...r.proxies] };
	e.default = a, t.exports = a, t.exports.proxyBundle = i;
})), require_ssl_profiles = /* @__PURE__ */ __commonJSMin(((e) => {
	e["Amazon RDS"] = { ca: require_lib().ca };
})), require_connection_config = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var { URL: n } = __require("url"), r = require_client(), i = require_charsets(), { version: a } = (init_package(), __toCommonJS(package_exports).default), o = null, s = {
		authPlugins: 1,
		authSwitchHandler: 1,
		bigNumberStrings: 1,
		charset: 1,
	...
	t.exports = class e {
		constructor(t) {
			...
			this.maxPacketSize = 0, this.charsetNumber = t.charset ? e.getCharsetNumber(t.charset) : t.charsetNumber || i.UTF8MB4_UNICODE_CI, this.compress = t.compress || !1, this.authPlugins = t.authPlugins, this.authSwitchHandler = t.authSwitchHandler, this.clientFlags = e.mergeFlags(e.getDefaultFlags(t), t.flags || ""), this.connectAttributes = {
				_client_name: "Node-MySQL-2",
				_client_version: a,
				...t.connectAttributes || {}
			}, this.maxPreparedStatements = t.maxPreparedStatements || 16e3, this.jsonStrings = t.jsonStrings || !1;
		}
		static mergeFlags(e, t) {
			let n = 0, i;
			for (i in Array.isArray(t) || (t = String(t || "").toUpperCase().split(/\s*,+\s*/)), e) t.indexOf(`-${e[i]}`) >= 0 || (n |= r[e[i]] || 0);
			for (i in t) t[i][0] !== "-" && (e.indexOf(t[i]) >= 0 || (n |= r[t[i]] || 0));
			return n;
		}
...
})), require_lru_cache = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, r = typeof AbortController == "function" ? AbortController : class {
		constructor() {
			this.signal = new o();
		}
		abort(e = /* @__PURE__ */ Error("This operation was aborted")) {
			this.signal.reason = this.signal.reason || e, this.signal.aborted = !0, this.signal.dispatchEvent({
				type: "abort",
				target: this.signal
			});
		}
	}, i = typeof AbortSignal == "function", a = typeof r.AbortSignal == "function", o = i ? AbortSignal : a ? r.AbortController : class {
		constructor() {
		...
		removeEventListener(e, t) {
			e === "abort" && (this._listeners = this._listeners.filter((e) => e !== t));
		}
	}, s = /* @__PURE__ */ new Set(), c = (e, t) => {
		let n = `LRU_CACHE_OPTION_${e}`;
		f(n) && p(n, `${e} option`, `options.${t}`, v);
	}, l = (e, t) => {
		let n = `LRU_CACHE_METHOD_${e}`;
		if (f(n)) {
			let { prototype: r } = v, { get: i } = Object.getOwnPropertyDescriptor(r, e);
			p(n, `${e} method`, `cache.${t}()`, i);
		}
	}, u = (e, t) => {
		let n = `LRU_CACHE_PROPERTY_${e}`;
		if (f(n)) {
			let { prototype: r } = v, { get: i } = Object.getOwnPropertyDescriptor(r, e);
			p(n, `${e} property`, `cache.${t}`, i);
		}
	}, d = (...e) => {
		typeof process == "object" && process && typeof process.emitWarning == "function" ? process.emitWarning(...e) : console.error(...e);
	}, f = (e) => !s.has(e), p = (e, t, n, r) => {
		s.add(e), d(`The ${t} is deprecated. Please use ${n} instead.`, "DeprecationWarning", e, r);
	}, m = (e) => e && e === Math.floor(e) && e > 0 && isFinite(e), h = (e) => m(e) ? e <= 2 ** 8 ? Uint8Array : e <= 2 ** 16 ? Uint16Array : e <= 2 ** 32 ? Uint32Array : e <= 2 ** 53 - 1 ? g : null : null, g = class extends Array {
		constructor(e) {
			super(e), this.fill(0);
		}
	}, _ = class {
		constructor(e) {
			if (e === 0) return [];
			this.heap = new (h(e))(e), this.length = 0;
		}
		push(e) {
			this.heap[this.length++] = e;
		}
		...
		constructor(t = {}) {
			let { max: n = 0, ttl: r, ttlResolution: i = 1, ttlAutopurge: a, updateAgeOnGet: o, updateAgeOnHas: l, allowStale: u, dispose: p, disposeAfter: g, noDisposeOnSet: v, noUpdateTTL: y, maxSize: b = 0, maxEntrySize: x = 0, sizeCalculation: S, fetchMethod: C, fetchContext: w, noDeleteOnFetchRejection: T, noDeleteOnStaleGet: E, allowStaleOnFetchRejection: D, allowStaleOnFetchAbort: O, ignoreFetchAbort: k } = t, { length: A, maxAge: j, stale: M } = t instanceof e ? {} : t;
			if (n !== 0 && !m(n)) throw TypeError("max option must be a nonnegative integer");
			let N = n ? h(n) : Array;
			if (!N) throw Error("invalid max value: " + n);
			if (this.max = n, this.maxSize = b, this.maxEntrySize = x || this.maxSize, this.sizeCalculation = S || A, this.sizeCalculation) {
				if (!this.maxSize && !this.maxEntrySize) throw TypeError("cannot set sizeCalculation without setting maxSize or maxEntrySize");
				if (typeof this.sizeCalculation != "function") throw TypeError("sizeCalculation set to non-function");
			}
			if (this.fetchMethod = C || null, this.fetchMethod && typeof this.fetchMethod != "function") throw TypeError("fetchMethod must be a function if specified");
			if (this.fetchContext = w, !this.fetchMethod && w !== void 0) throw TypeError("cannot set fetchContext without fetchMethod");
			if (this.keyMap = /* @__PURE__ */ new Map(), this.keyList = Array(n).fill(null), this.valList = Array(n).fill(null), this.next = new N(n), this.prev = new N(n), this.head = 0, this.tail = 0, this.free = new _(n), this.initialFill = 1, this.size = 0, typeof p == "function" && (this.dispose = p), typeof g == "function" ? (this.disposeAfter = g, this.disposed = []) : (this.disposeAfter = null, this.disposed = null), this.noDisposeOnSet = !!v, this.noUpdateTTL = !!y, this.noDeleteOnFetchRejection = !!T, this.allowStaleOnFetchRejection = !!D, this.allowStaleOnFetchAbort = !!O, this.ignoreFetchAbort = !!k, this.maxEntrySize !== 0) {
				if (this.maxSize !== 0 && !m(this.maxSize)) throw TypeError("maxSize must be a positive integer if specified");
				if (!m(this.maxEntrySize)) throw TypeError("maxEntrySize must be a positive integer if specified");
				this.initializeSizeTracking();
			}
			if (this.allowStale = !!u || !!M, this.noDeleteOnStaleGet = !!E, this.updateAgeOnGet = !!o, this.updateAgeOnHas = !!l, this.ttlResolution = m(i) || i === 0 ? i : 1, this.ttlAutopurge = !!a, this.ttl = r || j || 0, this.ttl) {
				if (!m(this.ttl)) throw TypeError("ttl must be a positive integer if specified");
				this.initializeTTLTracking();
			}
			if (this.max === 0 && this.ttl === 0 && this.maxSize === 0) throw TypeError("At least one of max, maxSize, or ttl is required");
			if (!this.ttlAutopurge && !this.max && !this.maxSize) {
				let t = "LRU_CACHE_UNBOUNDED";
				f(t) && (s.add(t), d("TTL caching without ttlAutopurge, max, or maxSize can result in unbounded memory consumption.", "UnboundedCacheWarning", t, e));
			}
			M && c("stale", "allowStale"), j && c("maxAge", "ttl"), A && c("length", "sizeCalculation");
		}
		getRemainingTTL(e) {
			return this.has(e, { updateAgeOnHas: !1 }) ? Infinity : 0;
		}
		initializeTTLTracking() {
			this.ttls = new g(this.max), this.starts = new g(this.max), this.setItemTTL = (e, t, r = n.now()) => {
				if (this.starts[e] = t === 0 ? 0 : r, this.ttls[e] = t, t !== 0 && this.ttlAutopurge) {
					let n = setTimeout(() => {
				...
				this.starts[e] = this.ttls[e] === 0 ? 0 : n.now();
			}, this.statusTTL = (n, r) => {
				n && (n.ttl = this.ttls[r], n.start = this.starts[r], n.now = e || t(), n.remainingTTL = n.now + n.ttl - n.start);
			};
			let e = 0, t = () => {
				let t = n.now();
				if (this.ttlResolution > 0) {
					e = t;
					let n = setTimeout(() => e = 0, this.ttlResolution);
			...
			this.getRemainingTTL = (n) => {
				let r = this.keyMap.get(n);
				return r === void 0 ? 0 : this.ttls[r] === 0 || this.starts[r] === 0 ? Infinity : this.starts[r] + this.ttls[r] - (e || t());
			}, this.isStale = (n) => this.ttls[n] !== 0 && this.starts[n] !== 0 && (e || t()) - this.starts[n] > this.ttls[n];
		}
		updateItemAge(e) {}
		statusTTL(e, t) {}
		setItemTTL(e, t, n) {}
		...
		initializeSizeTracking() {
			this.calculatedSize = 0, this.sizes = new g(this.max), this.removeItemSize = (e) => {
				...
				if (!m(n)) if (r) {
					if (typeof r != "function") throw TypeError("sizeCalculation must be a function");
					if (n = r(t, e), !m(n)) throw TypeError("sizeCalculation return invalid (expect positive integer)");
				} else throw TypeError("invalid size value (must be positive integer). When maxSize or maxEntrySize is used, sizeCalculation or size must be set.");
				return n;
			}, this.addItemSize = (e, t, n) => {
				if (this.sizes[e] = t, this.maxSize) {
					let t = this.maxSize - this.sizes[e];
					for (; this.calculatedSize > t;) this.evict(!0);
				}
				this.calculatedSize += this.sizes[e], n && (n.entrySize = t, n.totalCalculatedSize = this.calculatedSize);
			};
		}
		removeItemSize(e) {}
		addItemSize(e, t) {}
		...
		*entries() {
			for (let e of this.indexes()) this.valList[e] !== void 0 && this.keyList[e] !== void 0 && !this.isBackgroundFetch(this.valList[e]) && (yield [this.keyList[e], this.valList[e]]);
		}
		*rentries() {
			for (let e of this.rindexes()) this.valList[e] !== void 0 && this.keyList[e] !== void 0 && !this.isBackgroundFetch(this.valList[e]) && (yield [this.keyList[e], this.valList[e]]);
		}
		*keys() {
			for (let e of this.indexes()) this.keyList[e] !== void 0 && !this.isBackgroundFetch(this.valList[e]) && (yield this.keyList[e]);
		}
		*rkeys() {
			for (let e of this.rindexes()) this.keyList[e] !== void 0 && !this.isBackgroundFetch(this.valList[e]) && (yield this.keyList[e]);
		}
		*values() {
			for (let e of this.indexes()) this.valList[e] !== void 0 && !this.isBackgroundFetch(this.valList[e]) && (yield this.valList[e]);
		}
		*rvalues() {
			for (let e of this.rindexes()) this.valList[e] !== void 0 && !this.isBackgroundFetch(this.valList[e]) && (yield this.valList[e]);
		}
		[Symbol.iterator]() {
			return this.entries();
		}
		find(e, t) {
			for (let n of this.indexes()) {
				let r = this.valList[n], i = this.isBackgroundFetch(r) ? r.__staleWhileFetching : r;
				if (i !== void 0 && e(i, this.keyList[n], this)) return this.get(this.keyList[n], t);
			}
		}
		forEach(e, t = this) {
			for (let n of this.indexes()) {
				let r = this.valList[n], i = this.isBackgroundFetch(r) ? r.__staleWhileFetching : r;
				i !== void 0 && e.call(t, i, this.keyList[n], this);
			}
		}
		rforEach(e, t = this) {
			for (let n of this.rindexes()) {
				let r = this.valList[n], i = this.isBackgroundFetch(r) ? r.__staleWhileFetching : r;
				i !== void 0 && e.call(t, i, this.keyList[n], this);
			}
		}
		...
		purgeStale() {
			let e = !1;
			for (let t of this.rindexes({ allowStale: !0 })) this.isStale(t) && (this.delete(this.keyList[t]), e = !0);
			return e;
		}
		dump() {
			let e = [];
			for (let t of this.indexes({ allowStale: !0 })) {
				let r = this.keyList[t], i = this.valList[t], a = this.isBackgroundFetch(i) ? i.__staleWhileFetching : i;
				if (a === void 0) continue;
				let o = { value: a };
				if (this.ttls) {
					o.ttl = this.ttls[t];
					let e = n.now() - this.starts[t];
					o.start = Math.floor(Date.now() - e);
				}
		...
		dispose(e, t, n) {}
		set(e, t, { ttl: n = this.ttl, start: r, noDisposeOnSet: i = this.noDisposeOnSet, size: a = 0, sizeCalculation: o = this.sizeCalculation, noUpdateTTL: s = this.noUpdateTTL, status: c } = {}) {
			if (a = this.requireSize(e, t, a, o), this.maxEntrySize && a > this.maxEntrySize) return c && (c.set = "miss", c.maxEntrySizeExceeded = !0), this.delete(e), this;
			let l = this.size === 0 ? void 0 : this.keyMap.get(e);
			if (l === void 0) l = this.newIndex(), this.keyList[l] = e, this.valList[l] = t, this.keyMap.set(e, l), this.next[this.tail] = l, this.prev[l] = this.tail, this.tail = l, this.size++, this.addItemSize(l, a, c), c && (c.set = "add"), s = !1;
			else {
				this.moveToTail(l);
				let n = this.valList[l];
				if (t !== n) {
					if (this.isBackgroundFetch(n) ? n.__abortController.abort(/* @__PURE__ */ Error("replaced")) : i || (this.dispose(n, e, "set"), this.disposeAfter && this.disposed.push([
						n,
						e,
						"set"
					])), this.removeItemSize(l), this.valList[l] = t, this.addItemSize(l, a, c), c) {
						c.set = "replace";
						let e = n && this.isBackgroundFetch(n) ? n.__staleWhileFetching : n;
						e !== void 0 && (c.oldValue = e);
					}
				} else c && (c.set = "update");
			}
			if (n !== 0 && this.ttl === 0 && !this.ttls && this.initializeTTLTracking(), s || this.setItemTTL(l, n, r), this.statusTTL(c, l), this.disposeAfter) for (; this.disposed.length;) this.disposeAfter(...this.disposed.shift());
			return this;
		}
		newIndex() {
			return this.size === 0 ? this.tail : this.size === this.max && this.max !== 0 ? this.evict(!1) : this.free.length === 0 ? this.initialFill++ : this.free.pop();
		}
		pop() {
			if (this.size) {
		...
		evict(e) {
			let t = this.head, n = this.keyList[t], r = this.valList[t];
			return this.isBackgroundFetch(r) ? r.__abortController.abort(/* @__PURE__ */ Error("evicted")) : (this.dispose(r, n, "evict"), this.disposeAfter && this.disposed.push([
				r,
				n,
				"evict"
			])), this.removeItemSize(t), e && (this.keyList[t] = null, this.valList[t] = null, this.free.push(t)), this.head = this.next[t], this.keyMap.delete(n), this.size--, t;
		}
		has(e, { updateAgeOnHas: t = this.updateAgeOnHas, status: n } = {}) {
			let r = this.keyMap.get(e);
			if (r !== void 0) if (this.isStale(r)) n && (n.has = "stale", this.statusTTL(n, r));
			else return t && this.updateItemAge(r), n && (n.has = "hit"), this.statusTTL(n, r), !0;
			else n && (n.has = "miss");
			return !1;
		}
		peek(e, { allowStale: t = this.allowStale } = {}) {
			let n = this.keyMap.get(e);
			if (n !== void 0 && (t || !this.isStale(n))) {
				let e = this.valList[n];
				return this.isBackgroundFetch(e) ? e.__staleWhileFetching : e;
			}
		}
		backgroundFetch(e, t, n, i) {
			let a = t === void 0 ? void 0 : this.valList[t];
			if (this.isBackgroundFetch(a)) return a;
			let o = new r();
			n.signal && n.signal.addEventListener("abort", () => o.abort(n.signal.reason));
			let s = {
				signal: o.signal,
				options: n,
				context: i
			}, c = (r, i = !1) => {
				let { aborted: a } = o.signal, c = n.ignoreFetchAbort && r !== void 0;
				return n.status && (a && !i ? (n.status.fetchAborted = !0, n.status.fetchError = o.signal.reason, c && (n.status.fetchAbortIgnored = !0)) : n.status.fetchResolved = !0), a && !c && !i ? u(o.signal.reason) : (this.valList[t] === f && (r === void 0 ? f.__staleWhileFetching ? this.valList[t] = f.__staleWhileFetching : this.delete(e) : (n.status && (n.status.fetchUpdated = !0), this.set(e, r, s.options))), r);
			}, l = (e) => (n.status && (n.status.fetchRejected = !0, n.status.fetchError = e), u(e)), u = (r) => {
				let { aborted: i } = o.signal, a = i && n.allowStaleOnFetchAbort, s = a || n.allowStaleOnFetchRejection, c = s || n.noDeleteOnFetchRejection;
				if (this.valList[t] === f && (!c || f.__staleWhileFetching === void 0 ? this.delete(e) : a || (this.valList[t] = f.__staleWhileFetching)), s) return n.status && f.__staleWhileFetching !== void 0 && (n.status.returnedStale = !0), f.__staleWhileFetching;
				if (f.__returned === f) throw r;
			}, d = (t, r) => {
				this.fetchMethod(e, a, s).then((e) => t(e), r), o.signal.addEventListener("abort", () => {
					(!n.ignoreFetchAbort || n.allowStaleOnFetchAbort) && (t(), n.allowStaleOnFetchAbort && (t = (e) => c(e, !0)));
				});
			};
			n.status && (n.status.fetchDispatched = !0);
			let f = new Promise(d).then(c, l);
			return f.__abortController = o, f.__staleWhileFetching = a, f.__returned = null, t === void 0 ? (this.set(e, f, {
				...s.options,
				status: void 0
			}), t = this.keyMap.get(e)) : this.valList[t] = f, f;
		}
		isBackgroundFetch(e) {
		...
		async fetch(e, { allowStale: t = this.allowStale, updateAgeOnGet: n = this.updateAgeOnGet, noDeleteOnStaleGet: r = this.noDeleteOnStaleGet, ttl: i = this.ttl, noDisposeOnSet: a = this.noDisposeOnSet, size: o = 0, sizeCalculation: s = this.sizeCalculation, noUpdateTTL: c = this.noUpdateTTL, noDeleteOnFetchRejection: l = this.noDeleteOnFetchRejection, allowStaleOnFetchRejection: u = this.allowStaleOnFetchRejection, ignoreFetchAbort: d = this.ignoreFetchAbort, allowStaleOnFetchAbort: f = this.allowStaleOnFetchAbort, fetchContext: p = this.fetchContext, forceRefresh: m = !1, status: h, signal: g } = {}) {
			if (!this.fetchMethod) return h && (h.fetch = "get"), this.get(e, {
				allowStale: t,
				updateAgeOnGet: n,
			...
			if (v === void 0) {
				h && (h.fetch = "miss");
				let t = this.backgroundFetch(e, v, _, p);
				return t.__returned = t;
			} else {
				let r = this.valList[v];
				if (this.isBackgroundFetch(r)) {
					let e = t && r.__staleWhileFetching !== void 0;
					return h && (h.fetch = "inflight", e && (h.returnedStale = !0)), e ? r.__staleWhileFetching : r.__returned = r;
				}
				let i = this.isStale(v);
				if (!m && !i) return h && (h.fetch = "hit"), this.moveToTail(v), n && this.updateItemAge(v), this.statusTTL(h, v), r;
				let a = this.backgroundFetch(e, v, _, p), o = a.__staleWhileFetching !== void 0, s = o && t;
				return h && (h.fetch = o && i ? "stale" : "refresh", s && i && (h.returnedStale = !0)), s ? a.__staleWhileFetching : a.__returned = a;
			}
		}
		get(e, { allowStale: t = this.allowStale, updateAgeOnGet: n = this.updateAgeOnGet, noDeleteOnStaleGet: r = this.noDeleteOnStaleGet, status: i } = {}) {
			let a = this.keyMap.get(e);
			if (a !== void 0) {
				let o = this.valList[a], s = this.isBackgroundFetch(o);
				return this.statusTTL(i, a), this.isStale(a) ? (i && (i.get = "stale"), s ? (i && (i.returnedStale = t && o.__staleWhileFetching !== void 0), t ? o.__staleWhileFetching : void 0) : (r || this.delete(e), i && (i.returnedStale = t), t ? o : void 0)) : (i && (i.get = "hit"), s ? o.__staleWhileFetching : (this.moveToTail(a), n && this.updateItemAge(a), o));
			} else i && (i.get = "miss");
		}
		connect(e, t) {
		...
		delete(e) {
			...
			if (this.size !== 0) {
				let n = this.keyMap.get(e);
				if (n !== void 0) if (t = !0, this.size === 1) this.clear();
				else {
					this.removeItemSize(n);
					let t = this.valList[n];
					this.isBackgroundFetch(t) ? t.__abortController.abort(/* @__PURE__ */ Error("deleted")) : (this.dispose(t, e, "delete"), this.disposeAfter && this.disposed.push([
						t,
						e,
						"delete"
					])), this.keyMap.delete(e), this.keyList[n] = null, this.valList[n] = null, n === this.tail ? this.tail = this.prev[n] : n === this.head ? this.head = this.next[n] : (this.next[this.prev[n]] = this.next[n], this.prev[this.next[n]] = this.prev[n]), this.size--, this.free.push(n);
				}
			}
		...
		clear() {
			for (let e of this.rindexes({ allowStale: !0 })) {
				let t = this.valList[e];
				if (this.isBackgroundFetch(t)) t.__abortController.abort(/* @__PURE__ */ Error("deleted"));
				else {
					let n = this.keyList[e];
					this.dispose(t, n, "delete"), this.disposeAfter && this.disposed.push([
						t,
						n,
						"delete"
					]);
	...
	t.exports = v;
})), require_named_placeholders = /* @__PURE__ */ __commonJSMin(((e, t) => {
	...
	function s(e) {
		e ||= {}, e.placeholder ||= "?";
		let t = 100, n;
		typeof e.cache == "number" && (t = e.cache), typeof e.cache == "object" && (n = e.cache), e.cache !== !1 && !n && (n = new (require_lru_cache())({ max: t }));
		function r(e, t) {
			let n = [];
		...
		function s(e, t) {
			let i;
			return n && (i = n.get(e)) ? r(i, t) : (i = a(o(e)), n && n.set(e, i), r(i, t));
		}
		return s.parse = o, s;
	}
	function c(e, t) {
		...
		let i = {}, a = 0, s = "", c, l = [];
		for (let e = 0; e < n[0].length; ++e) c = i[n[1][e]], c || (c = ++a, i[n[1][e]] = c), n[1][e] ? (l[c - 1] = n[1][e], s += n[0][e] + "$" + c) : s += n[0][e];
		return [s, l.map((e) => t[e])];
	}
	t.exports = s, t.exports.toNumbered = c;
})), require_connection = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = __require("net"), r = __require("tls"), i = __require("timers"), a = require_events().EventEmitter, o = __require("stream").Readable, s = require_denque(), c = require_sqlstring(), l = require_index_cjs().default, u = require_packet_parser(), d = require_packets(), f = require_commands(), p = require_connection_config(), m = require_charset_encodings(), h = 0, _ = null;
	t.exports = class e extends a {
		constructor(e) {
			super(), this.config = e.config, e.config.stream ? typeof e.config.stream == "function" ? this.stream = e.config.stream(e) : this.stream = e.config.stream : e.config.socketPath ? this.stream = n.connect(e.config.socketPath) : (this.stream = n.connect(e.config.port, e.config.host), this.config.enableKeepAlive && this.stream.on("connect", () => {
				this.stream.setKeepAlive(!0, this.config.keepAliveInitialDelay);
			}), this.stream.setNoDelay(!0)), this._internalId = h++, this._commands = new s(), this._command = null, this._paused = !1, this._paused_packets = new s(), this._statements = new l({
				max: this.config.maxPreparedStatements,
				dispose: function(e) {
					e.close();
				}
			}), this.serverCapabilityFlags = 0, this.authorized = !1, this.sequenceId = 0, this.compressedSequenceId = 0, this.threadId = null, this._handshakePacket = null, this._fatalError = null, this._protocolError = null, this._outOfOrderPackets = [], this.clientEncoding = m[this.config.charsetNumber], this.stream.on("error", this._handleNetworkError.bind(this)), this.packetParser = new u((e) => {
				this.handlePacket(e);
			}), this.stream.on("data", (e) => {
				this.connectTimeout &&= (i.clearTimeout(this.connectTimeout), null), this.packetParser.execute(e);
			}), this.stream.on("end", () => {
				this.emit("end");
			...
			let t;
			if (this.config.isServer || (t = new f.ClientHandshake(this.config.clientFlags), t.on("end", () => {
			...
			}), this.addCommand(t)), this.serverEncoding = "utf8", this.config.connectTimeout) {
				let e = this._handleTimeoutError.bind(this);
				this.connectTimeout = i.setTimeout(e, this.config.connectTimeout);
			}
		}
		promise(e) {
			let t = require_promise().PromiseConnection;
			return new t(this, e);
		}
		...
		_handleNetworkError(e) {
			this.connectTimeout &&= (i.clearTimeout(this.connectTimeout), null), !(e.code === "ECONNRESET" && this._closing) && this._handleFatalError(e);
		}
		_handleTimeoutError() {
			this.connectTimeout &&= (i.clearTimeout(this.connectTimeout), null), this.stream.destroy && this.stream.destroy();
			let e = /* @__PURE__ */ Error("connect ETIMEDOUT");
			e.errorno = "ETIMEDOUT", e.code = "ETIMEDOUT", e.syscall = "connect", this._handleNetworkError(e);
		}
		_notifyError(e) {
			if (this.connectTimeout &&= (i.clearTimeout(this.connectTimeout), null), this._fatalError) return;
			let t, n = !this._command;
			for (this._command && this._command.onResult ? (this._command.onResult(e), this._command = null) : this._command && this._command.constructor === f.ClientHandshake && this._commands.length > 0 || (n = !0); t = this._commands.shift();) t.onResult ? t.onResult(e) : n = !0;
		...
		startTLS(e) {
			...
			}), n = this.config.ssl.rejectUnauthorized, i = this.config.ssl.verifyIdentity, a = this.config.host, o = !1;
			this.stream.removeAllListeners("data");
			let s = r.connect({
				rejectUnauthorized: n,
				requestCert: n,
				checkServerIdentity: i ? r.checkServerIdentity : function() {},
				secureContext: t,
				isServer: !1,
				socket: this.stream,
				servername: a
			}, () => {
				if (o = !0, n && typeof a == "string" && i) {
					let t = s.getPeerCertificate(!0), n = r.checkServerIdentity(a, t);
					if (n) {
						e(n);
						return;
					}
			...
			s.on("error", (t) => {
				o ? this._handleNetworkError(t) : e(t);
			}), s.on("data", (e) => {
				this.packetParser.execute(e);
			}), this.write = (e) => s.write(e);
		}
		protocolError(e, t) {
		...
		format(e, t) {
			...
			return this._resolveNamedPlaceholders(n), c.format(n.sql, n.values, this.config.stringifyObjects, this.config.timezone);
		}
		escape(e) {
			return c.escape(e, !1, this.config.timezone);
		}
		escapeId(e) {
			return c.escapeId(e, !1);
		}
		raw(e) {
			return c.raw(e);
		}
		_resolveNamedPlaceholders(e) {
			...
			if (this.config.namedPlaceholders || e.namedPlaceholders) {
				...
				_ === null && (_ = require_named_placeholders()()), t = _(e.sql, e.values), e.sql = t[0], e.values = t[1];
			}
		}
		query(t, n, r) {
			let i;
			i = t.constructor === f.Query ? t : e.createQuery(t, n, r, this.config), this._resolveNamedPlaceholders(i);
			let a = this.format(i.sql, i.values === void 0 ? [] : i.values);
			return i.sql = a, this.addCommand(i);
		}
		pause() {
		...
		prepare(e, t) {
			return typeof e == "string" && (e = { sql: e }), this.addCommand(new f.Prepare(e, t));
		}
		unprepare(t) {
			let n = {};
		...
		execute(e, t, n) {
			...
			let i = new f.Execute(r, n), a = new f.Prepare(r, (e, t) => {
				if (e) {
					i.start = function() {
						return null;
					}, n ? n(e) : i.emit("error", e), i.emit("end");
					return;
				}
				i.statement = t;
			});
			return this.addCommand(a), this.addCommand(i), i;
		}
		changeUser(e, t) {
			!t && typeof e == "function" && (t = e, e = {});
			let n = e.charset ? p.getCharsetNumber(e.charset) : this.config.charsetNumber;
			return this.addCommand(new f.ChangeUser({
		...
		ping(e) {
			return this.addCommand(new f.Ping(e));
		}
		_registerSlave(e, t) {
			return this.addCommand(new f.RegisterSlave(e, t));
		}
		_binlogDump(e, t) {
			return this.addCommand(new f.BinlogDump(e, t));
		}
		destroy() {
			this.close();
		}
		close() {
			this.connectTimeout &&= (i.clearTimeout(this.connectTimeout), null), this._closing = !0, this.stream.end(), this.addCommand = this._addCommandClosedState;
		}
		createBinlogStream(e) {
			let t = 1, n = new o({ objectMode: !0 });
		...
		connect(e) {
			...
			function n(n) {
				return function(r) {
					t || (n ? e(r) : e(null, r)), t = 1;
				};
			}
			this.once("error", n(!0)), this.once("connect", n(!1));
		}
		writeColumns(e) {
			this.writePacket(d.ResultSetHeader.toPacket(e.length)), e.forEach((e) => {
				this.writePacket(d.ColumnDefinition.toPacket(e, this.serverConfig.encoding));
			}), this.writeEof();
		}
		writeTextRow(e) {
			this.writePacket(d.TextRow.toPacket(e, this.serverConfig.encoding));
		}
		writeBinaryRow(e) {
			this.writePacket(d.BinaryRow.toPacket(e, this.serverConfig.encoding));
		}
		...
		writeEof(e, t) {
			this.writePacket(d.EOF.toPacket(e, t));
		}
		writeOk(e) {
			e ||= { affectedRows: 0 }, this.writePacket(d.OK.toPacket(e, this.serverConfig.encoding));
		}
		writeError(e) {
			let t = this.serverConfig ? this.serverConfig.encoding : "cesu8";
			this.writePacket(d.Error.toPacket(e, t));
		}
		serverHandshake(e) {
			return this.serverConfig = e, this.serverConfig.encoding = m[this.serverConfig.characterSet], this.addCommand(new f.ServerHandshake(e));
		}
		end(e) {
			...
			let t = this.addCommand(new f.Quit(e));
		...
		static createQuery(e, t, n, r) {
			...
			return typeof e == "object" ? (i = {
				...
				sql: e.sql,
				values: e.values
			}, typeof t == "function" ? n = t : t !== void 0 && (i.values = t)) : typeof t == "function" ? (n = t, i.sql = e, i.values = void 0) : (i.sql = e, i.values = t), new f.Query(i, n);
		}
		static statementKey(e) {
			return `${typeof e.nestTables}/${e.nestTables}/${e.rowsAsArray}${e.sql}`;
		}
	};
})), require_pool_connection = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_mysql2().Connection, r = class extends n {
		constructor(e, t) {
			super(t), this._pool = e, this.lastActiveTime = Date.now(), this.once("end", () => {
		...
		promise(e) {
			let t = require_promise().PromisePoolConnection;
			return new t(this, e);
		}
		end() {
			let e = /* @__PURE__ */ Error("Calling conn.end() to release a pooled connection is deprecated. In next version calling conn.end() will be restored to default conn.end() behavior. Use conn.release() instead.");
			this.emit("warn", e), console.warn(e.message), this.release();
		}
		destroy() {
...
})), require_pool = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_browser(), r = require_mysql2(), i = require_events().EventEmitter, a = require_pool_connection(), o = require_denque(), s = require_connection();
	function c(e, t) {
		let n = e.length;
	...
	t.exports = class extends i {
		constructor(e) {
			super(), this.config = e.config, this.config.connectionConfig.pool = this, this._allConnections = new o(), this._freeConnections = new o(), this._connectionQueue = new o(), this._closed = !1, this.config.maxIdle < this.config.connectionLimit && this._removeIdleTimeoutConnections();
		}
		promise(e) {
			let t = require_promise().PromisePool;
			return new t(this, e);
		}
		getConnection(e) {
			if (this._closed) return n.nextTick(() => e(/* @__PURE__ */ Error("Pool is closed.")));
			let t;
			return this._freeConnections.length > 0 ? (t = this._freeConnections.pop(), this.emit("acquire", t), n.nextTick(() => e(null, t))) : this.config.connectionLimit === 0 || this._allConnections.length < this.config.connectionLimit ? (t = new a(this, { config: this.config.connectionConfig }), this._allConnections.push(t), t.connect((n) => this._closed ? e(/* @__PURE__ */ Error("Pool is closed.")) : n ? e(n) : (this.emit("connection", t), this.emit("acquire", t), e(null, t)))) : this.config.waitForConnections ? this.config.queueLimit && this._connectionQueue.length >= this.config.queueLimit ? e(/* @__PURE__ */ Error("Queue limit reached.")) : (this.emit("enqueue"), this._connectionQueue.push(e)) : n.nextTick(() => e(/* @__PURE__ */ Error("No connections available.")));
		}
		releaseConnection(e) {
			let t;
			e._pool ? this._connectionQueue.length ? (t = this._connectionQueue.shift(), n.nextTick(t.bind(null, null, e))) : (this._freeConnections.push(e), this.emit("release", e)) : this._connectionQueue.length && (t = this._connectionQueue.shift(), n.nextTick(this.getConnection.bind(this, t)));
		}
		end(e) {
			this._closed = !0, clearTimeout(this._removeIdleTimeoutConnectionsTimer), typeof e != "function" && (e = function(e) {
				if (e) throw e;
			});
			let t = !1, n = 0, r, i = function(r) {
			...
			for (let e = 0; e < this._allConnections.length; e++) r = this._allConnections.get(e), r._realEnd(i);
		}
		query(e, t, n) {
			let r = s.createQuery(e, t, n, this.config.connectionConfig);
		...
		_removeConnection(e) {
			c(this._allConnections, e), c(this._freeConnections, e), this.releaseConnection(e);
		}
		_removeIdleTimeoutConnections() {
			this._removeIdleTimeoutConnectionsTimer && clearTimeout(this._removeIdleTimeoutConnectionsTimer), this._removeIdleTimeoutConnectionsTimer = setTimeout(() => {
				try {
					for (; this._freeConnections.length > this.config.maxIdle && Date.now() - this._freeConnections.get(0).lastActiveTime > this.config.idleTimeout;) this._freeConnections.get(0).destroy();
				} finally {
		...
		format(e, t) {
			return r.format(e, t, this.config.connectionConfig.stringifyObjects, this.config.connectionConfig.timezone);
		}
		escape(e) {
			return r.escape(e, this.config.connectionConfig.stringifyObjects, this.config.connectionConfig.timezone);
		}
		escapeId(e) {
			return r.escapeId(e, !1);
		}
	};
})), require_pool_config = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_connection_config();
	t.exports = class {
		constructor(e) {
...
})), require_pool_cluster = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = require_browser(), r = require_pool(), i = require_pool_config(), a = require_connection(), o = require_events().EventEmitter, s = {
		RR() {
			let e = 0;
		...
		constructor(e, t, n) {
			this._cluster = e, this._pattern = t, this._selector = s[n]();
		}
		getConnection(e) {
			let t = this._getClusterNode();
			return t === null ? e(/* @__PURE__ */ Error("Pool does Not exists.")) : this._cluster._getConnection(t, (t, n) => t ? e(t) : n === "retry" ? this.getConnection(e) : e(null, n));
		}
		query(e, t, n) {
			let r = a.createQuery(e, t, n, {});
	...
	t.exports = class extends o {
		constructor(e) {
			super(), e ||= {}, this._canRetry = e.canRetry === void 0 ? !0 : e.canRetry, this._removeNodeErrorCount = e.removeNodeErrorCount || 5, this._defaultSelector = e.defaultSelector || "RR", this._closed = !1, this._lastId = 0, this._nodes = {}, this._serviceableNodeIds = [], this._namespaces = {}, this._findCaches = {};
		}
		of(e, t) {
			e ||= "*", t ||= this._defaultSelector, t = t.toUpperCase(), !s[t] === "undefined" && (t = this._defaultSelector);
			let n = e + t;
			return this._namespaces[n] === void 0 && (this._namespaces[n] = new c(this, e, t)), this._namespaces[n];
		}
		add(e, t) {
			typeof e == "object" && (t = e, e = `CLUSTER::${++this._lastId}`), this._nodes[e] === void 0 && (this._nodes[e] = {
				id: e,
				errorCount: 0,
				pool: new r({ config: new i(t) })
		...
		getConnection(e, t, n) {
			...
			this._closed = !0;
			let r = !1, i = 0, a = (e) => {
				if (!r && (e || --i <= 0)) return r = !0, t(e);
			};
			for (let e in this._nodes) i++, this._nodes[e].pool.end(a);
			i === 0 && n.nextTick(a);
		}
		_findNodeIds(e) {
			if (this._findCaches[e] !== void 0) return this._findCaches[e];
			let t;
			if (e === "*") t = this._serviceableNodeIds;
			else if (this._serviceableNodeIds.indexOf(e) !== -1) t = [e];
			else {
				let n = e.substring(e.length - 1, 0);
				t = this._serviceableNodeIds.filter((e) => e.startsWith(n));
			}
			return this._findCaches[e] = t, t;
		}
		_getNode(e) {
			return this._nodes[e] || null;
		}
		_increaseErrorCount(e) {
			if (++e.errorCount >= this._removeNodeErrorCount) {
				let t = this._serviceableNodeIds.indexOf(e.id);
				t !== -1 && (this._serviceableNodeIds.splice(t, 1), delete this._nodes[e.id], this._clearFindCaches(), e.pool.end(), this.emit("remove", e.id));
			}
		}
		_decreaseErrorCount(e) {
			e.errorCount > 0 && --e.errorCount;
		}
		_getConnection(e, t) {
			e.pool.getConnection((n, r) => n ? (this._increaseErrorCount(e), this._canRetry ? (this.emit("warn", n), console.warn(`[Error] PoolCluster : ${n}`), t(null, "retry")) : t(n)) : (this._decreaseErrorCount(e), r._clusterId = e.id, t(null, r)));
		}
		_clearFindCaches() {
			this._findCaches = {};
		}
	};
})), require_server = /* @__PURE__ */ __commonJSMin(((e, t) => {
	var n = __require("net"), r = require_events().EventEmitter, i = require_connection(), a = require_connection_config();
	t.exports = class extends r {
		constructor() {
			super(), this.connections = [], this._server = n.createServer(this._handleConnection.bind(this));
		}
		_handleConnection(e) {
			let t = new i({ config: new a({
				stream: e,
				isServer: !0
			}) });
		...
		listen(e) {
			return this._port = e, this._server.listen.apply(this._server, arguments), this;
		}
		close(e) {
			this._server.close(e);
		}
	};
})), require_auth_plugins = /* @__PURE__ */ __commonJSMin(((e, t) => {
	t.exports = {
...
})), require_mysql2 = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_sqlstring(), n = require_connection(), r = require_connection_config(), i = require_parser_cache();
	e.createConnection = function(e) {
		return new n({ config: new r(e) });
	}, e.connect = e.createConnection, e.Connection = n, e.ConnectionConfig = r;
	var a = require_pool(), o = require_pool_cluster();
	e.createPool = function(e) {
		return new a({ config: new (require_pool_config())(e) });
	}, e.createPoolCluster = function(e) {
		return new (require_pool_cluster())(e);
	}, e.createQuery = n.createQuery, e.Pool = a, e.PoolCluster = o, e.createServer = function(e) {
		let t = new (require_server())();
		return e && t.on("connection", e), t;
	}, e.PoolConnection = require_pool_connection(), e.authPlugins = require_auth_plugins(), e.escape = t.escape, e.escapeId = t.escapeId, e.format = t.format, e.raw = t.raw, e.__defineGetter__("createConnectionPromise", () => require_promise().createConnection), e.__defineGetter__("createPoolPromise", () => require_promise().createPool), e.__defineGetter__("createPoolClusterPromise", () => require_promise().createPoolCluster), e.__defineGetter__("Types", () => require_types()), e.__defineGetter__("Charsets", () => require_charsets()), e.__defineGetter__("CharsetToEncoding", () => require_charset_encodings()), e.setMaxParserCache = function(e) {
		i.setMaxCache(e);
	}, e.clearParserCache = function() {
		i.clearCache();
	};
})), require_promise = /* @__PURE__ */ __commonJSMin(((e) => {
	var t = require_mysql2(), n = require_events().EventEmitter, r = require_parser_cache();
	function i(e, t, n) {
		return function(r, i, a) {
			r ? (n.message = r.message, n.code = r.code, n.errno = r.errno, n.sql = r.sql, n.sqlState = r.sqlState, n.sqlMessage = r.sqlMessage, t(n)) : e([i, a]);
		};
	}
	function a(e, t, n) {
		let r = {};
	...
	var o = class {
		...
		execute(e) {
			let t = this.statement, n = /* @__PURE__ */ Error();
			return new this.Promise((r, a) => {
				let o = i(r, a, n);
				e ? t.execute(e, o) : t.execute(o);
			});
		}
		close() {
		...
		constructor(e, t) {
			super(), this.connection = e, this.Promise = t || Promise, a(e, this, [
				"error",
				"drain",
				"connect",
				"end",
		...
		query(e, t) {
			let n = this.connection, r = /* @__PURE__ */ Error();
			if (typeof t == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((a, o) => {
				let s = i(a, o, r);
				t === void 0 ? n.query(e, s) : n.query(e, t, s);
			});
		}
		execute(e, t) {
			let n = this.connection, r = /* @__PURE__ */ Error();
			...
			return new this.Promise((a, o) => {
				let s = i(a, o, r);
				t === void 0 ? n.execute(e, s) : n.execute(e, t, s);
			});
		}
		end() {
			return new this.Promise((e) => {
		...
		beginTransaction() {
			let e = this.connection, t = /* @__PURE__ */ Error();
			return new this.Promise((n, r) => {
				let a = i(n, r, t);
				e.beginTransaction(a);
			});
		}
		commit() {
			let e = this.connection, t = /* @__PURE__ */ Error();
		...
		ping() {
			...
			return new this.Promise((n, r) => {
				e.ping((e) => {
					e ? (t.message = e.message, t.code = e.code, t.errno = e.errno, t.sqlState = e.sqlState, t.sqlMessage = e.sqlMessage, r(t)) : n(!0);
				});
			});
		}
		connect() {
			...
			return new this.Promise((n, r) => {
				e.connect((e, i) => {
					e ? (t.message = e.message, t.code = e.code, t.errno = e.errno, t.sqlState = e.sqlState, t.sqlMessage = e.sqlMessage, r(t)) : n(i);
				});
			});
		}
		prepare(e) {
			let t = this.connection, n = this.Promise, r = /* @__PURE__ */ Error();
			return new this.Promise((i, a) => {
				t.prepare(e, (e, t) => {
					e ? (r.message = e.message, r.code = e.code, r.errno = e.errno, r.sqlState = e.sqlState, r.sqlMessage = e.sqlMessage, a(r)) : i(new o(t, n));
				});
			});
		}
		changeUser(e) {
			let t = this.connection, n = /* @__PURE__ */ Error();
			return new this.Promise((r, i) => {
				t.changeUser(e, (e) => {
					e ? (n.message = e.message, n.code = e.code, n.errno = e.errno, n.sqlState = e.sqlState, n.sqlMessage = e.sqlMessage, i(n)) : r();
				});
			});
		}
		get config() {
	...
	function c(e) {
		let n = t.createConnection(e), r = /* @__PURE__ */ Error(), i = e.Promise || Promise;
		if (!i) throw Error("no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }");
		return new i((e, t) => {
			n.once("connect", () => {
				e(new s(n, i));
			}), n.once("error", (e) => {
				r.message = e.message, r.code = e.code, r.errno = e.errno, r.sqlState = e.sqlState, t(r);
			});
		});
	}
	(function(e) {
		for (let n = 0; e && n < e.length; n++) {
			let r = e[n];
			typeof t.Connection.prototype[r] == "function" && s.prototype[r] === void 0 && (s.prototype[r] = (function(e) {
				return function() {
					return t.Connection.prototype[e].apply(this.connection, arguments);
				};
			})(r));
		}
	})([
	...
	var l = class extends s {
		...
		destroy() {
			return t.PoolConnection.prototype.destroy.apply(this.connection, arguments);
		}
	}, u = class extends n {
		constructor(e, t) {
			super(), this.pool = e, this.Promise = t || Promise, a(e, this, [
				"acquire",
				"connection",
				"enqueue",
				"release"
		...
		getConnection() {
			...
			return new this.Promise((t, n) => {
				e.getConnection((e, r) => {
					e ? n(e) : t(new l(r, this.Promise));
				});
			});
		}
		releaseConnection(e) {
			e instanceof l && e.release();
		}
		query(e, t) {
			let n = this.pool, r = /* @__PURE__ */ Error();
			if (typeof t == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((a, o) => {
				let s = i(a, o, r);
				t === void 0 ? n.query(e, s) : n.query(e, t, s);
		...
		execute(e, t) {
			...
			return new this.Promise((a, o) => {
				let s = i(a, o, r);
				t ? n.execute(e, t, s) : n.execute(e, s);
			});
		}
		end() {
			let e = this.pool, t = /* @__PURE__ */ Error();
			return new this.Promise((n, r) => {
				e.end((e) => {
					e ? (t.message = e.message, t.code = e.code, t.errno = e.errno, t.sqlState = e.sqlState, t.sqlMessage = e.sqlMessage, r(t)) : n();
				});
			});
		}
	};
	function d(e) {
		let n = t.createPool(e), r = e.Promise || Promise;
	...
	(function(e) {
		for (let n = 0; e && n < e.length; n++) {
			let r = e[n];
			typeof t.Pool.prototype[r] == "function" && u.prototype[r] === void 0 && (u.prototype[r] = (function(e) {
				return function() {
					return t.Pool.prototype[e].apply(this.pool, arguments);
				};
			})(r));
		}
	})([
	...
	var f = class e extends n {
		constructor(e, t) {
			super(), this.poolCluster = e, this.Promise = t || Promise, a(e, this, ["warn", "remove"]);
		}
		getConnection() {
			let e = this.poolCluster;
			return new this.Promise((t, n) => {
				e.getConnection((e, r) => {
					e ? n(e) : t(new l(r, this.Promise));
				});
		...
		query(e, t) {
			let n = this.poolCluster, r = /* @__PURE__ */ Error();
			if (typeof t == "function") throw Error("Callback function is not available with promise clients.");
			return new this.Promise((a, o) => {
				let s = i(a, o, r);
				n.query(e, t, s);
		...
		of(t, n) {
			return new e(this.poolCluster.of(t, n), this.Promise);
		}
		end() {
			let e = this.poolCluster, t = /* @__PURE__ */ Error();
			return new this.Promise((n, r) => {
				e.end((e) => {
					e ? (t.message = e.message, t.code = e.code, t.errno = e.errno, t.sqlState = e.sqlState, t.sqlMessage = e.sqlMessage, r(t)) : n();
				});
	...
	(function(e) {
		for (let n = 0; e && n < e.length; n++) {
			let r = e[n];
			typeof t.PoolCluster.prototype[r] == "function" && f.prototype[r] === void 0 && (f.prototype[r] = (function(e) {
				return function() {
					return t.PoolCluster.prototype[e].apply(this.poolCluster, arguments);
				};
			})(r));
		}
	})(["add"]);
	function p(e) {
		let n = t.createPoolCluster(e), r = e && e.Promise || Promise;
		if (!r) throw Error("no Promise implementation available.Use promise-enabled node version or pass userland Promise implementation as parameter, for example: { Promise: require('bluebird') }");
		return new f(n, r);
	}
	e.createConnection = c, e.createPool = d, e.createPoolCluster = p, e.escape = t.escape, e.escapeId = t.escapeId, e.format = t.format, e.raw = t.raw, e.PromisePool = u, e.PromiseConnection = s, e.PromisePoolConnection = l, e.__defineGetter__("Types", () => require_types()), e.__defineGetter__("Charsets", () => require_charsets()), e.__defineGetter__("CharsetToEncoding", () => require_charset_encodings()), e.setMaxParserCache = function(e) {
		r.setMaxCache(e);
	}, e.clearParserCache = function() {
		r.clearCache();
	};
})), import_promise = require_promise(), NUMBER_REGEX = "^-?[0-9]+(.[0-9]+)?$";
async function connectMySQL(e) {
	let t = await (0, import_promise.createConnection)(e);
	try {
		return await t.connect(), await t.query("SELECT 1"), t;
	} catch (e) {
		throw await t.end(), e instanceof Error ? Error(`MySQL connection error: ${e.message}`) : e;
	}
}
function getEnumName(e, t) {
	return `${e}_${t}_enum`;
}
function getGenerationExpression(e, t) {
	return e === "VIRTUAL GENERATED" ? `GENERATED ALWAYS AS (${t}) VIRTUAL` : e === "STORED GENERATED" ? `GENERATED ALWAYS AS (${t}) STORED` : e.includes("on update CURRENT_TIMESTAMP") ? "on update CURRENT_TIMESTAMP" : "";
}
function getDbDefault(e, t) {
	return e === null ? null : {
		value: e,
		type: t
	};
}
function getFieldType$3(e, t, n, r, i, a) {
	if (r === "enum") return getEnumName(e, t);
	let o = getGenerationExpression(i, a);
	return o ? `${n} ${o}` : n;
}
function generateField$3(e) {
	let { tableName: t, columnName: n, columnDefault: r, defaultValueType: i, columnIsNullable: a, columnType: o, columnDataType: s, columnComment: c, columnExtra: l, generationExpression: u } = e, d = getFieldType$3(t, n, o, s, l, u), f = getDbDefault(r, i);
	return {
		name: n,
		type: {
			type_name: d,
		...
		dbdefault: f,
		not_null: a !== "YES",
		increment: l === "auto_increment",
		note: { value: c || "" }
	};
}
function getIndexColumn(e, t, n) {
	return t ? {
		value: t,
		type: "expression"
	} : n ? {
...
async function generateEnums(e, t) {
	return (await e.query("\n    select\n      t.table_name as tableName,\n      c.column_name as columnName,\n      TRIM(LEADING 'enum' FROM c.column_type) AS rawValues\n    from information_schema.tables t\n    join information_schema.columns c\n    on t.table_schema = c.table_schema and t.table_name = c.table_name\n    where\n      t.table_schema = ? and t.table_type = 'BASE TABLE' and c.data_type = 'enum'\n    order by\n      t.table_name, c.ordinal_position;\n  ", [t]))[0].map((e) => {
		let { tableName: t, columnName: n, rawValues: r } = e, i = r.slice(1, -1).split(",").map((e) => ({ name: e.slice(1, -1) }));
		return {
			name: getEnumName(t, n),
			values: i
		};
	});
}
async function generateIndexes$2(e, t) {
	let n = (await e.query("\n    with\n      pk_fk_uniques as (\n        select constraint_name, table_name\n        from information_schema.table_constraints\n        where table_schema = ?\n      )\n    select\n      st.table_name as tableName,\n      case\n        when st.non_unique = 0 then true\n        else false\n        end as isIdxUnique,\n      st.index_name as idxName,\n      st.column_name as columnName,\n      st.sub_part as idxSubPart,\n      st.index_type as idxType,\n      replace(st.expression, '`', '') as idxExpression\n    from information_schema.statistics st\n    where\n      st.table_schema = ?\n      and st.index_name not in (\n        select constraint_name\n        from pk_fk_uniques pfu\n        where pfu.table_name = st.table_name\n      )\n      and st.index_type in ('BTREE', 'HASH')\n    group by\n      st.table_name, st.non_unique, st.index_name, st.column_name, st.sub_part, st.index_type, st.expression\n    order by st.index_name;\n  ", [t, t]))[0].reduce((e, t) => {
		let { tableName: n, idxName: r, idxType: i, isIdxUnique: a, columnName: o, idxExpression: s, idxSubPart: c } = t, l = n;
		e[l] || (e[l] = {}), e[l][r] || (e[l][r] = {
			name: r,
			type: i,
			columns: [],
		...
		let u = e[l][r], d = getIndexColumn(o, s, c);
		return d && u.columns.push(d), e;
	}, {}), r = {};
	return Object.keys(n).forEach((e) => {
		r[e] = flatten_default(Object.values(n[e]));
	}), r;
}
async function generatePrimaryAndUniqueConstraint(e, t) {
	let n = (await e.query("\n    select\n      tc.table_name as tableName,\n      tc.constraint_name as constraintName,\n      group_concat(kcu.column_name order by kcu.ordinal_position separator ',') as columnNames,\n      count(kcu.column_name) as columnCount,\n      tc.constraint_type as constraintType\n    from information_schema.table_constraints tc\n    join information_schema.key_column_usage kcu\n    on\n      tc.constraint_schema = kcu.constraint_schema\n      and tc.constraint_name = kcu.constraint_name\n      and tc.table_name = kcu.table_name\n    where\n      (tc.constraint_type = 'PRIMARY KEY' or tc.constraint_type = 'UNIQUE')\n      and tc.table_schema = ?\n    group by tc.table_name, tc.constraint_name, tc.constraint_type\n    order by tc.table_name, tc.constraint_name;\n  ", [t]))[0], r = n.filter((e) => e.columnCount === 1), i = n.filter((e) => e.columnCount > 1).reduce((e, t) => {
		let { tableName: n, constraintName: r, columnNames: i, constraintType: a } = t, o = n;
		e[o] || (e[o] = {}), e[o][r] || (e[o][r] = { name: r }), a === "PRIMARY KEY" && (e[o][r].pk = !0), a === "UNIQUE" && (e[o][r].unique = !0);
		let s = i.split(",").map((e) => ({
			type: "column",
			value: e
		}));
		return e[o][r].columns = s, e;
	}, {}), a = {};
	return Object.keys(i).forEach((e) => {
		a[e] = flatten_default(Object.values(i[e]));
	}), {
		compositeConstraintMap: a,
		primaryAndUniqueConstraintMap: r.reduce((e, t) => {
			let { tableName: n, columnNames: r, constraintType: i } = t, a = n;
			return e[a] || (e[a] = {}), r.split(",").forEach((t) => {
				e[a][t] || (e[a][t] = { checks: [] }), i === "PRIMARY KEY" && (e[a][t].pk = !0), i === "UNIQUE" && !e[a][t].pk && (e[a][t].unique = !0);
			}), e;
		}, {})
	};
}
function extractColumnsFromCheckConstraint(e) {
	return [...e.matchAll(/`(?:``|[^`])*`/g)].map((e) => e.toString().slice(1, -1));
}
async function generateCheckConstraints(e, t) {
	let n = (await e.query("\n    select\n      cc.constraint_name as constraintName,\n      tc.table_name as tableName,\n      cc.check_clause as checkClause\n    from information_schema.check_constraints cc\n    join information_schema.table_constraints tc\n      on cc.constraint_name = tc.constraint_name\n    where cc.constraint_schema = ?\n  ", [t]))[0], r = {}, i = {};
	return n.forEach((e) => {
		let { constraintName: t, tableName: n, checkClause: a } = e, o = n, s = extractColumnsFromCheckConstraint(a);
		if (s.length === 1) {
			let e = s[0];
			i[o] || (i[o] = {}), i[o][e] || (i[o][e] = { checks: [] }), i[o][e].checks.push({
				name: t,
				expression: a.slice(1, -1)
			});
			return;
...
async function generateForeignKeys(e, t) {
	return (await e.query("\n    select\n      rc.constraint_name as constraintName,\n      rc.table_name as foreignTableName,\n      group_concat(kcu.column_name order by kcu.ordinal_position separator ',') as foreignColumnNames,\n      kcu.referenced_table_name as refTableName,\n      group_concat(kcu.referenced_column_name order by kcu.ordinal_position separator ',') as refColumnNames,\n      rc.update_rule as onUpdate,\n      rc.delete_rule as onDelete\n    from information_schema.referential_constraints rc\n    join information_schema.key_column_usage kcu\n    on\n      rc.constraint_name = kcu.constraint_name\n      and rc.table_name = kcu.table_name\n      and rc.constraint_schema = kcu.table_schema\n    where rc.constraint_schema = ?\n    group by\n      rc.constraint_name,\n      rc.table_name,\n      kcu.referenced_table_name,\n      rc.update_rule,\n      rc.delete_rule\n    order by\n      rc.table_name;\n  ", [t]))[0].map((e) => {
		let { constraintName: t, onDelete: n, onUpdate: r, foreignTableName: i, foreignColumnNames: a, refTableName: o, refColumnNames: s } = e;
		return {
			name: t,
			endpoints: [{
				tableName: i,
			...
			onDelete: n === "NO ACTION" ? null : n,
			onUpdate: r === "NO ACTION" ? null : r
		};
	});
}
function combineIndexAndCompositeConstraint(e, t) {
...
async function fetchSchemaJson$2(e) {
	let t = await connectMySQL(e), { database: n } = t.config;
	if (!n) throw Error("Cannot get schema name from the connection");
	try {
		let [{ tableList: e, fieldMap: r }, i, a, { primaryAndUniqueConstraintMap: o, compositeConstraintMap: s }, c, { checks: l, tableConstraints: u }] = await Promise.all([
			generateTablesAndFields$3(t, n),
			generateEnums(t, n),
			generateIndexes$2(t, n),
			generatePrimaryAndUniqueConstraint(t, n),
			generateForeignKeys(t, n),
			generateCheckConstraints(t, n)
		]), d = combineIndexAndCompositeConstraint(a, s), f = { ...o };
		return Object.keys(u).forEach((e) => {
			f[e] || (f[e] = {}), Object.keys(u[e]).forEach((t) => {
				f[e][t] || (f[e][t] = { checks: [] }), f[e][t].checks.push(...u[e][t].checks);
			});
		}), {
			tables: e,
			fields: r,
...
const LIST_SEPARATOR = "@@@@@@@@", EXECUTE_OPTIONS = { outFormat: oracledb.OUT_FORMAT_OBJECT };
function processEasyConnectString(e) {
	let { username: t, password: n, dbidentifier: r } = e.match(/^(?<username>[^/@:]+)\/(?<password>[^/@:]+)@(\/\/)?(?<dbidentifier>.+)$/)?.groups || {};
	if (!t || !n || !r) throw Error("Invalid Easy Connect string. Expect a string of format 'username/password@[//]host[:port][/database]'");
	return {
		username: t,
		password: n,
		dbidentifier: r
...
async function generateConstraints(e) {
	let t = `
    ...
    ORDER BY
      ...
      ac.CONSTRAINT_NAME
  `, n = {}, r = {}, i = {};
	return (await e.execute(t, [], EXECUTE_OPTIONS)).rows?.forEach((e) => {
		let { constraint_name: t, table_name: a, columns: o, column_count: s, check_expression: c, constraint_type: l } = e, u = a, d = t || "", f = (o || "").split(LIST_SEPARATOR), p = s || 1, m = l, h = c || null;
		if (m === "C" && h && p > 1) {
			i[u] || (i[u] = []);
			let e = {
				name: d,
		...
		if (m === "C" && h && p === 1 && f.length === 1) {
			r[u] || (r[u] = {});
			let e = f[0];
			r[u][e] || (r[u][e] = { checks: [] }), r[u][e].checks.push({
				name: d,
				expression: h
			});
		}
		if (["P", "U"].includes(m) && p === 1 && f.length === 1) {
			r[u] || (r[u] = {});
			let e = f[0];
			r[u][e] || (r[u][e] = { checks: [] }), r[u][e].pk ||= m === "P", r[u][e].unique ||= m === "U";
		}
		if (["P", "U"].includes(m) && p > 1) {
			r[u] || (r[u] = {}), n[u] || (n[u] = []);
			let e = {
				name: d,
				type: "",
...
async function generateIndexes$1(e) {
	...
	return t.rows?.forEach((e) => {
		let { index_name: t, table_name: n, index_type: i, is_unique: a, column_name: o, column_expression: s } = e, c = t, l = n, u = i, d = !!a;
		if (s) {
			r[c] || (r[c] = {
				table: l,
				type: u,
	...
	}), Object.entries(r).forEach(([e, { table: t, type: r, unique: i, columns: a }]) => {
		let o = {
			name: e,
			type: r,
			unique: i,
...
async function generateRawRefs$1(e) {
	let t = [], n = `
    SELECT
    ...
    ORDER BY
      ...
      c.CONSTRAINT_NAME
  `;
	return (await e.execute(n, [], EXECUTE_OPTIONS)).rows?.forEach((e) => {
		let { fk_name: n, child_table: r, child_columns: i, parent_table: a, parent_columns: o, delete_rule: s } = e, c = {
			tableName: r,
			schemaName: "",
			fieldNames: i.split(LIST_SEPARATOR),
			relation: "*"
		}, l = {
			tableName: a,
			schemaName: "",
			fieldNames: o.split(LIST_SEPARATOR),
			relation: "1"
		};
		t.push({
			name: n,
			endpoints: [c, l],
			onDelete: s === "NO ACTION" ? null : s,
			onUpdate: null
		});
	}), t;
}
async function generateTablesAndFields$2(e) {
	let t = {}, n = (await e.execute("\n    SELECT\n      cols.TABLE_NAME AS \"table_name\",\n      cols.COLUMN_NAME AS \"column_name\",\n      cols.COLUMN_ID AS \"column_id\",\n      cols.DATA_TYPE AS \"data_type\",\n      cols.DATA_LENGTH AS \"data_length\",\n      cols.DATA_PRECISION AS \"data_precision\",\n      cols.DATA_SCALE AS \"data_scale\",\n      CASE WHEN cols.IDENTITY_COLUMN = 'YES' THEN 1 ELSE 0 END AS \"identity_increment\",\n      CASE WHEN cols.NULLABLE = 'Y' THEN 1 ELSE 0 END AS \"is_nullable\",\n      cols.DATA_DEFAULT AS \"data_default\",\n      tcoms.COMMENTS AS \"table_comment\",\n      ccoms.COMMENTS AS \"column_comment\",\n      obj.CREATED AS \"table_created\"\n    FROM USER_TAB_COLUMNS cols\n    LEFT JOIN USER_COL_COMMENTS ccoms\n      ON ccoms.COLUMN_NAME = cols.COLUMN_NAME\n      AND ccoms.TABLE_NAME = cols.TABLE_NAME\n    LEFT JOIN USER_TAB_COMMENTS tcoms\n      ON tcoms.TABLE_NAME = cols.TABLE_NAME\n    LEFT JOIN USER_OBJECTS obj\n      ON obj.OBJECT_NAME = cols.TABLE_NAME\n      AND obj.OBJECT_TYPE = 'TABLE'\n    ORDER BY obj.CREATED, obj.OBJECT_ID, cols.COLUMN_ID\n  ", [], EXECUTE_OPTIONS)).rows?.reduce((e, n) => {
		let { table_name: r, table_comment: i } = n;
		e[r] || (e[r] = {
			name: r,
			schemaName: "",
			note: i ? { value: i } : { value: "" }
		}), t[r] || (t[r] = []);
		let a = generateField$2(n);
		return t[r].push(a), e;
	}, {}) || {};
	return {
		tables: Object.values(n),
		fields: t
	};
}
function getDefaultType(e) {
	if (e == null) return "expression";
	let t = e.trim();
	return /^'.*'$/.test(t) ? "string" : /^[0-9]+$/.test(t) || /^[0-9]*\.[0-9]*$/.test(t) ? "number" : "expression";
}
function generateField$2(e) {
	let { column_name: t, data_type: n, data_length: r, data_precision: i, data_scale: a, identity_increment: o, is_nullable: s, data_default: c, column_comment: l } = e, u = getDefaultType(c), d = c && !o ? getDbdefault$2(c, u) : null;
	return {
		name: t,
		type: {
			type_name: getFieldType$2(n, r, i, a),
			schemaName: null
		},
		dbdefault: d,
		not_null: !s,
		increment: !!o,
		note: l ? { value: l } : { value: "" }
	};
}
function getDbdefault$2(e, t) {
	return e === null ? null : t === "string" ? {
		value: e.trim().slice(1, -1).replaceAll("''", "'"),
		type: t
	} : {
		value: e,
		type: t
...
var SIZED_DATA_TYPES = new Set([
	...
	"national char"
]), PRECISION_DATA_TYPES = new Set(["float"]), TIMESTAMP_WITH_LOCAL_TIME_ZONE_DATA_TYPE = "timestamp with local time zone", TIMESTAMP_WITH_TIME_ZONE_DATA_TYPE = "timestamp with time zone", TIMESTAMP_DATA_TYPE = "timestamp", INTERVAL_YEAR_DATA_TYPE = "interval year to month", INTERVAL_DAY_DATA_TYPE = "interval day to second", PRECISION_SCALED_DATA_TYPES = new Set([
	"number",
	"numeric",
	"decimal",
	"dec"
]);
function normalizeFieldType(e) {
	let t = e.split(" ").filter(Boolean).join(" ").toLowerCase();
	switch (t) {
		case "anydata": return "AnyData";
		case "anytype": return "AnyType";
		case "anydataset": return "AnyDataSet";
		case "xmltype": return "XMLType";
		case "uritype": return "URIType";
		case "sdo_geometry": return "SDO_Geometry";
		case "sdo_topo_geometry": return "SDO_Topo_Geometry";
		case "sdo_georaster": return "SDO_GeoRaster";
		default: return t;
	}
}
function getFieldType$2(e, t, n, r) {
	let i = normalizeFieldType(e);
	return i === TIMESTAMP_WITH_LOCAL_TIME_ZONE_DATA_TYPE ? r === null ? i : `timestamp (${r}) with local time zone` : i === TIMESTAMP_WITH_TIME_ZONE_DATA_TYPE ? r === null ? i : `timestamp (${r}) with time zone` : i === TIMESTAMP_DATA_TYPE ? r === null ? i : `timestamp (${r})` : i === INTERVAL_YEAR_DATA_TYPE ? n === null ? i : `interval year (${n}) to month` : i === INTERVAL_DAY_DATA_TYPE ? n !== null && r !== null ? `interval day (${n}) to second (${r})` : n === null ? r === null ? i : `interval day to second (${r})` : `interval day (${n}) to second` : SIZED_DATA_TYPES.has(i) ? t ? `${i}(${t})` : i : PRECISION_DATA_TYPES.has(i) ? n === null ? i : `${i}(${n})` : PRECISION_SCALED_DATA_TYPES.has(i) ? n !== null && r !== null ? `${i}(${n}, ${r})` : n === null ? i : `${i}(${n})` : i;
}
var getValidatedClient$1 = async (e, t, n) => {
	let r = await getConnection({
		username: e,
		password: t,
		connectionString: n
	});
	try {
		return await r.execute("SELECT 1 FROM DUAL"), r;
	} catch (e) {
		throw await r.close(), e instanceof Error ? Error(`OracleSQL connection error: ${e.message}`) : e;
	}
};
async function fetchSchemaJson$3(e) {
	let { username: t, password: n, dbidentifier: r } = processEasyConnectString(e), i = await getValidatedClient$1(t, n, r), a = generateTablesAndFields$2(i), o = generateConstraints(i), s = generateRawRefs$1(i), c = generateIndexes$1(i), l = await Promise.all([
		a,
		o,
		s,
		c
	]), { tables: u, fields: d } = l[0], { indexes: f, tableConstraints: p, checks: m } = l[1], h = l[2], g = l[3];
	return Object.keys(f).forEach((e) => {
		g[e] ? g[e].push(...f[e]) : g[e] = f[e];
	}), await i.close(), {
		tables: u,
		fields: d,
		refs: h,
...
var getValidatedClient = async (e) => {
	let t = new Client(e);
	try {
		return await t.connect(), await t.query("SELECT 1"), t;
	} catch (e) {
		throw await t.end(), e instanceof Error ? Error(`PostgreSQL connection error: ${e}`) : e;
	}
}, convertQueryBoolean$1 = (e) => e === "YES", getFieldType$1 = (e, t, n, r, i) => e === "ARRAY" ? `${t.slice(1, t.length)}[]` : n ? `${t}(${n})` : r && i ? `${t}(${r},${i})` : t, getDbdefault$1 = (e, t, n) => {
	if (e === "ARRAY") return {
		type: n,
		value: `ARRAY[${t.slice(6, -1).split(",").map((e) => e.split("::")[0]).join(", ")}]`
	};
	if (n === "string") {
		let n = t.split("::")[0];
		return {
			type: e === "json" || e === "jsonb" ? "expression" : "string",
			value: n.slice(1, -1)
		};
	}
	return {
	...
	let { column_name: t, data_type: n, character_maximum_length: r, numeric_precision: i, numeric_scale: a, udt_schema: o, udt_name: s, identity_increment: c, is_nullable: l, column_default: u, default_type: d, column_comment: f } = e, p = u && d !== "increment" ? getDbdefault$1(n, u, d) : null;
	return {
		name: t,
		type: n === "USER-DEFINED" ? {
			type_name: s,
			...
			type_name: getFieldType$1(n, s, r, i, a),
			schemaName: null
		},
		dbdefault: p,
		not_null: !convertQueryBoolean$1(l),
		increment: !!c || d === "increment",
		note: f ? { value: f } : { value: "" }
	};
}, generateTablesAndFields$1 = async (e, t) => {
	let n = {}, r = `
    WITH
      comments AS (
    ...
    WHERE
      ...
      ${buildSchemaQuery("t.table_schema", t)}
    ORDER BY
      t.table_schema,
      tp.table_ordinal_position,
      c.ordinal_position
    ;
  `, i = (await e.query(r)).rows.reduce((e, t) => {
		let { table_schema: r, table_name: i, table_comment: a } = t, o = `${r}.${i}`;
		e[o] || (e[o] = {
			name: i,
			schemaName: r,
    ...
    WHERE tc.constraint_type = 'FOREIGN KEY'
      ...
      ${buildSchemaQuery("tc.table_schema", t)}
    GROUP BY
      tc.table_schema,
      tc.table_name,
      tc.constraint_name,
    ...
    ORDER BY
      ...
      tc.table_name;
  `;
	return (await e.query(r)).rows.forEach((e) => {
		let { table_schema: t, fk_constraint_name: r, table_name: i, column_names: a, foreign_table_schema: o, foreign_table_name: s, foreign_column_names: c, on_delete: l, on_update: u } = e, d = {
			tableName: i,
			schemaName: t,
			fieldNames: a.split(","),
			relation: "*"
		...
		n.push({
			name: r,
			endpoints: [d, f],
			onDelete: l === "NO ACTION" ? null : l,
			onUpdate: u === "NO ACTION" ? null : u
		});
	}), n;
}, generateIndexesAndConstraints = async (e, t) => {
	let n = `
    WITH user_tables AS (
      SELECT
    ...
    ${buildSchemaQuery("ut.tableschema", t)}
    ORDER BY
      ut.tablename,
      ii.constraint_type,
      ii.index_name
    ;
  `, { outOfLineIndexes: r, inlineIndexes: i } = (await e.query(n)).rows.reduce((e, t) => {
		let { constraint_type: n, index_columns: r } = t;
		return r === "null" || r.trim() === "" || (r.split(",").length === 1 && (n === "PRIMARY KEY" || n === "UNIQUE") ? e.inlineIndexes.push(t) : e.outOfLineIndexes.push(t)), e;
	}, {
		outOfLineIndexes: [],
		inlineIndexes: []
	}), a = r.reduce((e, t) => {
		let { table_schema: n, table_name: r, index_name: i, index_type: a, index_columns: o, index_expressions: s, is_primary: c, is_unique: l } = t, u = o.split(",").map((e) => ({
			type: "column",
			value: e.trim()
		})), d = s ? s.split(",").map((e) => ({
			type: "expression",
	...
	i.forEach((e) => {
		let { table_schema: t, table_name: n, index_columns: r, constraint_type: i } = e, a = `${t}.${n}`;
		o[a] || (o[a] = {}), r.split(",").map((e) => e.trim()).forEach((e) => {
			o[a][e] || (o[a][e] = { checks: [] }), i === "PRIMARY KEY" && (o[a][e].pk = !0), i === "UNIQUE" && !o[a][e].pk && (o[a][e].unique = !0);
		});
	}, {});
    ...
    GROUP BY
      ...
      con.oid
  `, c = await e.query(s), l = {};
	return c.rows.forEach((e) => {
		let { table_schema: t, table_name: n, check_name: r, check_definition: i, column_name: a, is_column_constraint: s } = e;
		if (typeof t != "string" || typeof n != "string" || typeof i != "string" || !i.match(/CHECK \(\(.*\)\)/) || s && typeof a != "string") return;
		let c = `${t}.${n}`;
		if (s) {
			o[c] || (o[c] = {}), o[c][a] || (o[c][a] = { checks: [] }), o[c][a].checks.push({
				name: r || void 0,
				expression: i.slice(8, -2)
			});
			return;
		}
		l[c] || (l[c] = []), l[c].push({
    ...
    ${buildSchemaQuery("n.nspname", t, "WHERE")}
    ORDER BY
      schema_name,
      enum_type,
      sort_order;
    ;
  `, r = (await e.query(n)).rows.reduce((e, t) => {
		let { schema_name: n, enum_type: r, enum_value: i } = t, a = `${n}.${r}`;
		return e[a] || (e[a] = {
			name: r,
			schemaName: n,
			values: []
		}), e[a].values.push({ name: i }), e;
	}, {});
	return Object.values(r);
}, fetchSchemaJson$4 = async (e) => {
	let { connectionString: t, schemas: n } = parseConnectionString$1(e, "jdbc"), r = await getValidatedClient(t);
	try {
		let e = generateTablesAndFields$1(r, n), t = generateIndexesAndConstraints(r, n), i = generateRawRefs(r, n), a = generateRawEnums(r, n), o = await Promise.all([
			e,
			t,
			i,
			a
		]), { tables: s, fields: c } = o[0], { indexes: l, tableConstraints: u, checks: d } = o[1];
		return {
			tables: s,
			fields: c,
			refs: o[2],
...
}, parseConnectionString = (e) => {
	let t = {}, n = /([^;=]+)=([^;]*)/g, r;
	for (; (r = n.exec(e)) !== null;) t[r[1].trim()] = r[2].trim();
	return t;
}, connect = async (e) => new Promise((t, n) => {
	console.log("Attempting to connect..."), e.connect((e) => {
		e ? n(e) : t();
	});
}), executeQuery = (e, t) => new Promise((n, r) => {
	console.log("Executing query..."), e.execute({
		sqlText: t,
		complete: (e, t, i) => {
			e ? r(e) : (console.log("Query executed successfully."), i && n(i));
		}
	});
}), isLogLevel = (e) => [
	"ERROR",
	...
	"DEBUG",
	"TRACE"
].includes(e), connectToSnowflake = async (e) => {
	let t = isLogLevel(e.LOG_LEVEL) ? e.LOG_LEVEL : "INFO", n = e.IS_DEBUG_MODE === "true";
	snowflake.configure({
		logLevel: t,
		additionalLogToConsole: n
	});
	let r = {};
	switch (e.AUTHENTICATOR) {
		case "SNOWFLAKE_JWT":
			r = {
				privateKeyPath: e.PRIVATE_KEY_PATH,
				privateKeyPass: e.PASSPHRASE
			};
			break;
		case "SNOWFLAKE":
		case void 0:
			r = { password: e.PWD };
			break;
		default: throw Error("Unsupported authenticator");
	}
	let i = {
		...
		timeout: 1e4,
		...r
	}, a = snowflake.createConnection(i);
	return await connect(a), await executeQuery(a, "SELECT CURRENT_VERSION();"), a;
}, convertQueryBoolean = (e) => e === "YES", getFieldType = (e, t, n, r) => t ? `${e}(${t})` : n && r ? `${e}(${n},${r})` : e, getDbdefault = (e, t) => t === "string" ? {
	type: t,
	value: e.slice(1, -1)
} : {
	type: t,
	...
	let { COLUMN_NAME: t, DATA_TYPE: n, CHARACTER_MAXIMUM_LENGTH: r, NUMERIC_PRECISION: i, NUMERIC_SCALE: a, IDENTITY_INCREMENT: o, IS_NULLABLE: s, COLUMN_DEFAULT: c, DEFAULT_TYPE: l, COLUMN_COMMENT: u } = e, d = c ? getDbdefault(c, l) : null;
	return {
		name: t,
		type: {
			type_name: getFieldType(n, r, i, a),
			schemaName: null
		},
		dbdefault: d,
		not_null: !convertQueryBoolean(s),
		increment: !!o,
		note: u ? { value: u } : { value: "" }
	};
}, generateTablesAndFields = async (e, t) => {
	let n = {}, r = (await executeQuery(e, `
    SELECT
        c.table_schema,
        c.table_name,
        c.column_name,
  ...
  `)).reduce((e, t) => {
		...
		let s = generateField(t);
		return n[o].push(s), e;
	}, {});
	return {
		tables: Object.values(r),
		fields: n
	};
}, createConstraintKeysMap = (e, t, n) => e.reduce((e, r) => {
	let { schema_name: i, table_name: a, column_name: o, constraint_name: s } = r;
	if (!(!(t.length > 0) || t.includes(i))) return e;
	let c = `${i}.${a}.${s}`;
	if (e[c]) {
		let { columnNames: t } = e[c];
		return t.push(o), e;
	}
	return e[c] = {
		schemaName: i,
...
}, {}), generateIndexes = async (e, t, n) => {
	let r = `
    SHOW PRIMARY KEYS IN DATABASE ${t};
  `, i = `
    SHOW UNIQUE KEYS IN DATABASE ${t};
  `, a = await executeQuery(e, r), o = await executeQuery(e, i), s = createConstraintKeysMap(a, n, "primary"), c = createConstraintKeysMap(o, n, "unique"), { indexes: l, tableConstraints: u } = [Object.values(s), Object.values(c)].flat().reduce((e, t) => {
		let { schemaName: n, tableName: r, constraintName: i, columnNames: a, type: o, primary: s, unique: c } = t, l = `${n}.${r}`;
		if (a.length < 2) return e.tableConstraints[l] = { [a[0]]: {
			pk: s,
			unique: c,
			checks: []
		} }, e;
		...
		return e.indexes[l] ? e.indexes[l].push(u) : e.indexes[l] = [u], e;
	}, {
		indexes: {},
		tableConstraints: {}
	});
...
}, fetchSchemaJson$5 = async (e) => {
	let t = parseConnectionString(e), n = await connectToSnowflake(t);
	if (n instanceof Error) throw n;
	let r = t.SCHEMAS ? parseSchema(t.SCHEMAS) : [], i = t.DATABASE, a = generateTablesAndFields(n, r), o = generateIndexes(n, i, r), s = await Promise.all([a, o]);
	n.destroy((e) => {
		if (e) throw e;
		console.log("Connection destroyed successfully.");
	});
	let { tables: c, fields: l } = s[0], { indexes: u, tableConstraints: d } = s[1];
	return {
		tables: c,
		fields: l,
		refs: [],
...
}, connector_exports = /* @__PURE__ */ __export({ fetchSchemaJson: () => fetchSchemaJson$6 }, 1), fetchSchemaJson$6 = async (e, t) => {
	switch (t) {
		case "postgres": return fetchSchemaJson$4(e);
		case "mssql": return fetchSchemaJson$1(e);
		case "mysql": return fetchSchemaJson$2(e);
		case "snowflake": return fetchSchemaJson$5(e);
		case "bigquery": return fetchSchemaJson(e);
		case "oracle": return fetchSchemaJson$3(e);
		default: throw Error(`Unsupported database type: ${t}`);
	}
};
export { connector_exports as connector };
