...
export declare enum CompileErrorCode {
    ...
    INVALID_TABLE_PARTIAL_SETTING_VALUE = 3062,
    ...
    UNKNOWN_TABLE_PARTIAL_SETTING = 3069,
    INVALID_TABLE_SETTING_VALUE = 3070,
    INVALID_CHECKS_CONTEXT = 3071,
    INVALID_CHECKS_FIELD = 3072,
    INVALID_CHECK = 3073,
    UNKNOWN_CHECK_SETTING = 3074,
    DUPLICATE_CHECK_SETTING = 3075,
    INVALID_CHECK_SETTING_VALUE = 3076,
    INVALID_RECORDS_CONTEXT = 3077,
    INVALID_RECORDS_NAME = 3078,
    INVALID_RECORDS_FIELD = 3079,
    DUPLICATE_COLUMN_REFERENCES_IN_RECORDS = 3080,
    DUPLICATE_RECORDS_FOR_TABLE = 3081,
    INVALID_DIAGRAMVIEW_CONTEXT = 3082,
    DUPLICATE_DIAGRAMVIEW_NAME = 3083,
    INVALID_DIAGRAMVIEW_FIELD = 3084,
    DUPLICATE_DIAGRAMVIEW_FIELD = 3085,
    BINDING_ERROR = 4000,
    UNSUPPORTED = 5000,
    CIRCULAR_REF = 5001,
    SAME_ENDPOINT = 5002,
...
export declare class CompileWarning extends Error {
    code: Readonly<CompileErrorCode>;
    diagnostic: Readonly<string>;
    nodeOrToken: Readonly<SyntaxNode | SyntaxToken>;
    start: Readonly<number>;
