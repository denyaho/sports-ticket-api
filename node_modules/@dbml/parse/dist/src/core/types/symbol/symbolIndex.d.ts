...
export declare function createPartialInjectionSymbolIndex(key: string): NodeSymbolIndex;
export declare function createDiagramViewSymbolIndex(key: string): NodeSymbolIndex;
export declare function createDiagramViewFieldSymbolIndex(key: string): NodeSymbolIndex;
export declare function createNodeSymbolIndex(key: string, symbolKind: SymbolKind): NodeSymbolIndex;
export declare function destructureIndex(id: NodeSymbolIndex): {
    name: string;
    kind: SymbolKind;
} | undefined;
